...
(function() {
  ...
  KeyData.decode = function(decoder) {
    ...
    val.domCode = decoder.decodeStruct(codec.Uint32);
  ...
  LocationData.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.relativeLocation = decoder.decodeStructPointer(geometry$.PointF);
    val.rootLocation = decoder.decodeStructPointer(geometry$.PointF);
    return val;
  };
  ...
  PointerDetails.decode = function(decoder) {
    ...
    val.twist = decoder.decodeStruct(codec.Float);
    val.id = decoder.decodeStruct(codec.Int32);
    val.offsetX = decoder.decodeStruct(codec.Int32);
    val.offsetY = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MouseData.encodedSize = codec.kStructHeaderSize + 32;
  ...
  MouseData.decode = function(decoder) {
    ...
    decoder.skip(1);
    val.location = decoder.decodeStructPointer(LocationData);
    val.pointerDetails = decoder.decodeStructPointer(PointerDetails);
    val.wheelOffset = decoder.decodeStructPointer(geometry$.Vector2d);
    return val;
  };
