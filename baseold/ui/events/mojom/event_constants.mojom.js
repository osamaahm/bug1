...
(function() {
  ...
  EventType.GESTURE_TAP = EventType.KEY_RELEASED + 1;
  EventType.GESTURE_SWIPE = EventType.GESTURE_TAP + 1;
  EventType.GESTURE_PINCH_BEGIN = EventType.GESTURE_SWIPE + 1;
  EventType.GESTURE_PINCH_END = EventType.GESTURE_PINCH_BEGIN + 1;
  EventType.GESTURE_PINCH_UPDATE = EventType.GESTURE_PINCH_END + 1;
  EventType.SCROLL = EventType.GESTURE_PINCH_UPDATE + 1;
  EventType.SCROLL_FLING_START = EventType.SCROLL + 1;
  EventType.SCROLL_FLING_CANCEL = EventType.SCROLL_FLING_START + 1;
  EventType.CANCEL_MODE = EventType.SCROLL_FLING_CANCEL + 1;
  EventType.MOUSE_PRESSED_EVENT = EventType.CANCEL_MODE + 1;
  EventType.MOUSE_DRAGGED_EVENT = EventType.MOUSE_PRESSED_EVENT + 1;
  EventType.MOUSE_RELEASED_EVENT = EventType.MOUSE_DRAGGED_EVENT + 1;
  EventType.MOUSE_MOVED_EVENT = EventType.MOUSE_RELEASED_EVENT + 1;
  EventType.MOUSE_ENTERED_EVENT = EventType.MOUSE_MOVED_EVENT + 1;
  EventType.MOUSE_EXITED_EVENT = EventType.MOUSE_ENTERED_EVENT + 1;
  EventType.MOUSE_WHEEL_EVENT = EventType.MOUSE_EXITED_EVENT + 1;
  EventType.MOUSE_CAPTURE_CHANGED_EVENT = EventType.MOUSE_WHEEL_EVENT + 1;
  EventType.TOUCH_RELEASED = EventType.MOUSE_CAPTURE_CHANGED_EVENT + 1;
  EventType.TOUCH_PRESSED = EventType.TOUCH_RELEASED + 1;
  EventType.TOUCH_MOVED = EventType.TOUCH_PRESSED + 1;
  EventType.TOUCH_CANCELLED = EventType.TOUCH_MOVED + 1;
  ...
  EventMomentumPhase.BLOCKED = EventMomentumPhase.END + 1;
  ...
  GestureDeviceType.DEVICE_TOUCHPAD = GestureDeviceType.DEVICE_UNKNOWN + 1;
  GestureDeviceType.DEVICE_TOUCHSCREEN = GestureDeviceType.DEVICE_TOUCHPAD + 1;
