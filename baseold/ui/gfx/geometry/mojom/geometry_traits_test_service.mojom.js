...
(function() {
  ...
  GeometryTraitsTestService_EchoPoint_Params.decode = function(decoder) {
    ...
    val.p = decoder.decodeStructPointer(geometry$.Point);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoPoint_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Point);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoPointF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.p = decoder.decodeStructPointer(geometry$.PointF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoPointF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.PointF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoPoint3F_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.p = decoder.decodeStructPointer(geometry$.Point3F);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoPoint3F_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Point3F);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoSize_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.s = decoder.decodeStructPointer(geometry$.Size);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoSize_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Size);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoSizeF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.s = decoder.decodeStructPointer(geometry$.SizeF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoSizeF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.SizeF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoRect_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.r = decoder.decodeStructPointer(geometry$.Rect);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoRect_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Rect);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoRectF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.r = decoder.decodeStructPointer(geometry$.RectF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoRectF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.RectF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoInsets_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.i = decoder.decodeStructPointer(geometry$.Insets);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoInsets_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Insets);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoInsetsF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.i = decoder.decodeStructPointer(geometry$.InsetsF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoInsetsF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.InsetsF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoVector2d_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.v = decoder.decodeStructPointer(geometry$.Vector2d);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoVector2d_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Vector2d);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoVector2dF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.v = decoder.decodeStructPointer(geometry$.Vector2dF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoVector2dF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Vector2dF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoVector3dF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.v = decoder.decodeStructPointer(geometry$.Vector3dF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoVector3dF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Vector3dF);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoQuaternion_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.q = decoder.decodeStructPointer(geometry$.Quaternion);
    return val;
  };
  ...
  GeometryTraitsTestService_EchoQuaternion_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(geometry$.Quaternion);
    return val;
  };
  ...
  var kGeometryTraitsTestService_EchoPoint_Name = 0;
  var kGeometryTraitsTestService_EchoPointF_Name = 1;
  var kGeometryTraitsTestService_EchoPoint3F_Name = 2;
  var kGeometryTraitsTestService_EchoSize_Name = 3;
  var kGeometryTraitsTestService_EchoSizeF_Name = 4;
  var kGeometryTraitsTestService_EchoRect_Name = 5;
  var kGeometryTraitsTestService_EchoRectF_Name = 6;
  var kGeometryTraitsTestService_EchoInsets_Name = 7;
  var kGeometryTraitsTestService_EchoInsetsF_Name = 8;
  var kGeometryTraitsTestService_EchoVector2d_Name = 9;
  var kGeometryTraitsTestService_EchoVector2dF_Name = 10;
  var kGeometryTraitsTestService_EchoVector3dF_Name = 11;
  var kGeometryTraitsTestService_EchoQuaternion_Name = 12;
