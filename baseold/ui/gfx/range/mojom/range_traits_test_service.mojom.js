...
(function() {
  ...
  RangeTraitsTestService_EchoRange_Params.decode = function(decoder) {
    ...
    val.p = decoder.decodeStructPointer(range$.Range);
    return val;
  };
  ...
  RangeTraitsTestService_EchoRange_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(range$.Range);
    return val;
  };
  ...
  RangeTraitsTestService_EchoRangeF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.p = decoder.decodeStructPointer(range$.RangeF);
    return val;
  };
  ...
  RangeTraitsTestService_EchoRangeF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(range$.RangeF);
    return val;
  };
  ...
  var kRangeTraitsTestService_EchoRange_Name = 0;
  var kRangeTraitsTestService_EchoRangeF_Name = 1;
