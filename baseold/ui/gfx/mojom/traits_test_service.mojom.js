...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'ui/gfx/mojom/accelerated_widget.mojom', 'accelerated_widget.mojom.js');
  }
  var buffer_types$ =
      mojo.internal.exposeNamespace('gfx.mojom');
  if (mojo.config.autoLoadMojomDeps) {
  ...
  TraitsTestService_EchoSelectionBound_Params.decode = function(decoder) {
    ...
    val.s = decoder.decodeStructPointer(selection_bound$.SelectionBound);
    return val;
  };
  ...
  TraitsTestService_EchoSelectionBound_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(selection_bound$.SelectionBound);
    return val;
  };
  ...
  TraitsTestService_EchoTransform_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.t = decoder.decodeStructPointer(transform$.Transform);
    return val;
  };
  ...
  TraitsTestService_EchoTransform_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(transform$.Transform);
    return val;
  };
  ...
  TraitsTestService_EchoGpuMemoryBufferHandle_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.g = decoder.decodeStructPointer(buffer_types$.GpuMemoryBufferHandle);
    return val;
  };
  ...
  TraitsTestService_EchoGpuMemoryBufferHandle_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(buffer_types$.GpuMemoryBufferHandle);
    return val;
  };
  ...
  TraitsTestService_EchoRRectF_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.t = decoder.decodeStructPointer(rrect_f$.RRectF);
    return val;
  };
  ...
  TraitsTestService_EchoRRectF_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pass = decoder.decodeStructPointer(rrect_f$.RRectF);
    return val;
  };
  ...
  var kTraitsTestService_EchoSelectionBound_Name = 0;
  var kTraitsTestService_EchoTransform_Name = 1;
  var kTraitsTestService_EchoGpuMemoryBufferHandle_Name = 2;
  var kTraitsTestService_EchoRRectF_Name = 3;
