...
(function() {
  ...
  AXActionData.encodedSize = codec.kStructHeaderSize + 96;
  ...
  AXActionData.decode = function(decoder) {
    ...
    val.targetNodeId = decoder.decodeStruct(codec.Int32);
    val.targetTreeId = decoder.decodeStruct(ax_tree_id$.AXTreeID);
    val.sourceExtensionId = decoder.decodeStruct(codec.String);
    val.requestId = decoder.decodeStruct(codec.Int32);
    val.flags = decoder.decodeStruct(codec.Int32);
    val.anchorNodeId = decoder.decodeStruct(codec.Int32);
    val.anchorOffset = decoder.decodeStruct(codec.Int32);
    val.focusNodeId = decoder.decodeStruct(codec.Int32);
    val.focusOffset = decoder.decodeStruct(codec.Int32);
    val.customActionId = decoder.decodeStruct(codec.Int32);
    val.hitTestEventToFire = decoder.decodeStruct(codec.Int32);
    val.targetRect = decoder.decodeStructPointer(geometry$.Rect);
    val.targetPoint = decoder.decodeStructPointer(geometry$.Point);
    val.value = decoder.decodeStruct(codec.String);
    val.horizontalScrollAlignment = decoder.decodeStruct(codec.Int32);
    val.verticalScrollAlignment = decoder.decodeStruct(codec.Int32);
    return val;
  };
