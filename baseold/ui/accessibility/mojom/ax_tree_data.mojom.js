...
(function() {
  ...
  AXTreeData.encodedSize = codec.kStructHeaderSize + 120;
  ...
  AXTreeData.decode = function(decoder) {
    ...
    val.treeId = decoder.decodeStruct(ax_tree_id$.AXTreeID);
    val.parentTreeId = decoder.decodeStruct(ax_tree_id$.AXTreeID);
    val.focusedTreeId = decoder.decodeStruct(ax_tree_id$.AXTreeID);
    val.doctype = decoder.decodeStruct(codec.String);
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.loadingProgress = decoder.decodeStruct(codec.Float);
    ...
    val.focusId = decoder.decodeStruct(codec.Int32);
    val.selAnchorObjectId = decoder.decodeStruct(codec.Int32);
    val.selAnchorOffset = decoder.decodeStruct(codec.Int32);
    val.selAnchorAffinity = decoder.decodeStruct(codec.Int32);
    val.selFocusObjectId = decoder.decodeStruct(codec.Int32);
    val.selFocusOffset = decoder.decodeStruct(codec.Int32);
    val.selFocusAffinity = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
