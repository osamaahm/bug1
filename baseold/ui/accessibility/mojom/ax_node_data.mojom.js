...
(function() {
  ...
  AXNodeData.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 16, false, new codec.Enum(ax_enums$.StringAttribute), codec.String, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.intAttributes
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 24, false, new codec.Enum(ax_enums$.IntAttribute), codec.Int32, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.floatAttributes
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 32, false, new codec.Enum(ax_enums$.FloatAttribute), codec.Float, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.boolAttributes
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 40, false, new codec.Enum(ax_enums$.BoolAttribute), codec.PackedBool, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.intlistAttributes
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 48, false, new codec.Enum(ax_enums$.IntListAttribute), new codec.ArrayOf(codec.Int32), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.stringlistAttributes
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 56, false, new codec.Enum(ax_enums$.StringListAttribute), new codec.ArrayOf(codec.String), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.htmlAttributes
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 64, false, codec.String, codec.String, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.childIds
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 72, 4, codec.Int32, false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AXNodeData.relativeBounds
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, ax_relative_bounds$.AXRelativeBounds, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AXNodeData.encodedSize = codec.kStructHeaderSize + 88;
  ...
  AXNodeData.decode = function(decoder) {
    ...
    val.state = decoder.decodeStruct(codec.Uint32);
    val.actions = decoder.decodeStruct(codec.Uint32);
    val.stringAttributes = decoder.decodeMapPointer(new codec.Enum(ax_enums$.StringAttribute), codec.String);
    val.intAttributes = decoder.decodeMapPointer(new codec.Enum(ax_enums$.IntAttribute), codec.Int32);
    val.floatAttributes = decoder.decodeMapPointer(new codec.Enum(ax_enums$.FloatAttribute), codec.Float);
    val.boolAttributes = decoder.decodeMapPointer(new codec.Enum(ax_enums$.BoolAttribute), codec.PackedBool);
    val.intlistAttributes = decoder.decodeMapPointer(new codec.Enum(ax_enums$.IntListAttribute), new codec.ArrayOf(codec.Int32));
    val.stringlistAttributes = decoder.decodeMapPointer(new codec.Enum(ax_enums$.StringListAttribute), new codec.ArrayOf(codec.String));
    val.htmlAttributes = decoder.decodeMapPointer(codec.String, codec.String);
    val.childIds = decoder.decodeArrayPointer(codec.Int32);
    val.relativeBounds = decoder.decodeStructPointer(ax_relative_bounds$.AXRelativeBounds);
    return val;
  };
  ...
  AXNodeData.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Uint32, val.actions);
