...
(function() {
  ...
  DisplaySnapshot.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 56, file_path$.FilePath, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DisplaySnapshot.modes
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 64, 8, new codec.PointerTo(display_mode$.DisplayMode), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DisplaySnapshot.panelOrientation
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 44, display_constants$.PanelOrientation);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DisplaySnapshot.edid
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 72, 1, codec.Uint8, false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 112, geometry$.Size, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DisplaySnapshot.encodedSize = codec.kStructHeaderSize + 120;
  ...
  DisplaySnapshot.decode = function(decoder) {
    ...
    val.panelOrientation = decoder.decodeStruct(codec.Int32);
