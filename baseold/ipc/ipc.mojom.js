...
(function() {
  ...
  Message.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 16, 8, new codec.PointerTo(native_struct$.SerializedHandle), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Message.encodedSize = codec.kStructHeaderSize + 24;
  ...
  Message.decode = function(decoder) {
    ...
    val.buffer = decoder.decodeStruct(big_buffer$.BigBuffer);
  ...
  Message.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(big_buffer$.BigBuffer, val.buffer);
  ...
  Channel_Receive_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.message = decoder.decodeStructPointer(Message);
    return val;
  };
