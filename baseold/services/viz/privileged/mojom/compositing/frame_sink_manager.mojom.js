...
(function() {
  ...
  RootCompositorFrameSinkParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateAssociatedInterfaceRequest(offset + codec.kStructHeaderSize + 44, false)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateAssociatedInterfaceRequest(offset + codec.kStructHeaderSize + 56, true)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kFrameSinkManager_RegisterFrameSinkId_Name = 0;
  var kFrameSinkManager_InvalidateFrameSinkId_Name = 1;
  var kFrameSinkManager_EnableSynchronizationReporting_Name = 2;
  var kFrameSinkManager_SetFrameSinkDebugLabel_Name = 3;
  var kFrameSinkManager_CreateRootCompositorFrameSink_Name = 4;
  var kFrameSinkManager_CreateCompositorFrameSink_Name = 5;
  var kFrameSinkManager_DestroyCompositorFrameSink_Name = 6;
  var kFrameSinkManager_RegisterFrameSinkHierarchy_Name = 7;
  var kFrameSinkManager_UnregisterFrameSinkHierarchy_Name = 8;
  var kFrameSinkManager_AddVideoDetectorObserver_Name = 9;
  var kFrameSinkManager_CreateVideoCapturer_Name = 10;
  var kFrameSinkManager_EvictSurfaces_Name = 11;
  var kFrameSinkManager_RequestCopyOfOutput_Name = 12;
  var kFrameSinkManager_SetHitTestAsyncQueriedDebugRegions_Name = 13;
  var kFrameSinkManager_CacheBackBuffer_Name = 14;
  var kFrameSinkManager_EvictBackBuffer_Name = 15;
  ...
  var kFrameSinkManagerClient_OnFirstSurfaceActivation_Name = 0;
  var kFrameSinkManagerClient_OnAggregatedHitTestRegionListUpdated_Name = 1;
  var kFrameSinkManagerClient_OnFrameTokenChanged_Name = 2;
