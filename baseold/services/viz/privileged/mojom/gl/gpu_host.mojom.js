...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'gpu/ipc/common/gpu_extra_info.mojom', '../../../../../gpu/ipc/common/gpu_extra_info.mojom.js');
  }
  var surface_handle$ =
      mojo.internal.exposeNamespace('gpu.mojom');
  if (mojo.config.autoLoadMojomDeps) {
  ...
  GpuHost_DidInitialize_Params.decode = function(decoder) {
    ...
    val.gpuExtraInfo = decoder.decodeStructPointer(gpu_extra_info$.GpuExtraInfo);
    return val;
  };
  ...
  var kGpuHost_DidFailInitialize_Name = 1;
  var kGpuHost_DidCreateContextSuccessfully_Name = 2;
  var kGpuHost_DidCreateOffscreenContext_Name = 3;
  var kGpuHost_DidDestroyOffscreenContext_Name = 4;
  var kGpuHost_DidDestroyChannel_Name = 5;
  var kGpuHost_DidLoseContext_Name = 6;
  var kGpuHost_DisableGpuCompositing_Name = 7;
  var kGpuHost_StoreShaderToDisk_Name = 8;
  var kGpuHost_RecordLogMessage_Name = 9;
