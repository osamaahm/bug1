...
(function() {
  ...
  CompositorFrameSink_DidAllocateSharedBitmap_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.region = decoder.decodeStructPointer(shared_memory$.ReadOnlySharedMemoryRegion);
  ...
  CompositorFrameSinkClient_OnBeginFrame_Params.decode = function(decoder) {
    ...
    val.details = decoder.decodeMapPointer(codec.Uint32, new codec.PointerTo(frame_timing_details$.FrameTimingDetails));
    return val;
  };
