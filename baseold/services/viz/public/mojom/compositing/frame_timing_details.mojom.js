...
(function() {
  ...
  FrameTimingDetails.decode = function(decoder) {
    ...
    val.receivedCompositorFrameTimestamp = decoder.decodeStructPointer(time$.TimeTicks);
    val.drawStartTimestamp = decoder.decodeStructPointer(time$.TimeTicks);
    val.swapTimings = decoder.decodeStructPointer(swap_timings$.SwapTimings);
    val.presentationFeedback = decoder.decodeStructPointer(presentation_feedback$.PresentationFeedback);
    return val;
  };
