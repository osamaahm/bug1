...
(function() {
  ...
  BarcodeDetectorOptions.decode = function(decoder) {
    ...
    val.formats = decoder.decodeArrayPointer(new codec.Enum(barcodedetection$.BarcodeFormat));
    return val;
  };
  ...
  BarcodeDetectionProvider_EnumerateSupportedFormats_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.supportedFormats = decoder.decodeArrayPointer(new codec.Enum(barcodedetection$.BarcodeFormat));
    return val;
  };
