...
(function() {
  ...
  NetworkInterface.decode = function(decoder) {
    ...
    val.interfaceIndex = decoder.decodeStruct(codec.Uint32);
    val.type = decoder.decodeStruct(codec.Int32);
    val.address = decoder.decodeStructPointer(ip_address$.IPAddress);
    val.prefixLength = decoder.decodeStruct(codec.Uint32);
    val.ipAddressAttributes = decoder.decodeStruct(codec.Int32);
    return val;
  };
