...
(function() {
  ...
  HttpRawRequestResponseInfo.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.httpStatusText = decoder.decodeStruct(codec.String);
    val.requestHeaders = decoder.decodeArrayPointer(new codec.PointerTo(http_raw_headers$.HttpRawHeaderPair));
    val.responseHeaders = decoder.decodeArrayPointer(new codec.PointerTo(http_raw_headers$.HttpRawHeaderPair));
    val.requestHeadersText = decoder.decodeStruct(codec.String);
    val.responseHeadersText = decoder.decodeStruct(codec.String);
    return val;
  };
