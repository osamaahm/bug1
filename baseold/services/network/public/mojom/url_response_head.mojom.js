...
(function() {
  ...
  URLResponseHead.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 108, fetch_api$.FetchResponseType);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLResponseHead.serviceWorkerStartTime
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 144, time$.TimeTicks, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLResponseHead.serviceWorkerReadyTime
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 176, network_param$.SSLInfo, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 192, network_param$.AuthChallengeInfo, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLResponseHead.contentSecurityPolicy
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 200, content_security_policy$.ContentSecurityPolicy, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLResponseHead.requestStart
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 208, time$.TimeTicks, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 224, origin_policy_manager$.OriginPolicy, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLResponseHead.recursivePrefetchToken
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 232, unguessable_token$.UnguessableToken, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLResponseHead.decode = function(decoder) {
    ...
    val.requestTime = decoder.decodeStructPointer(time$.Time);
    ...
    val.charset = decoder.decodeStruct(codec.String);
    val.ctPolicyCompliance = decoder.decodeStruct(codec.Int32);
    ...
    val.isInCacheStorage = (packed >> 7) & 1 ? true : false;
    packed = decoder.readUint8();
    val.didServiceWorkerNavigationPreload = (packed >> 0) & 1 ? true : false;
    val.shouldReportCorbBlocking = (packed >> 1) & 1 ? true : false;
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.contentLength = decoder.decodeStruct(codec.Int64);
    val.encodedDataLength = decoder.decodeStruct(codec.Int64);
    val.encodedBodyLength = decoder.decodeStruct(codec.Int64);
    val.appcacheId = decoder.decodeStruct(codec.Int64);
    val.appcacheManifestUrl = decoder.decodeStructPointer(url$.Url);
    val.loadTiming = decoder.decodeStructPointer(load_timing_info$.LoadTimingInfo);
    val.rawRequestResponseInfo = decoder.decodeStructPointer(http_raw_request_response_info$.HttpRawRequestResponseInfo);
    val.connectionInfo = decoder.decodeStruct(codec.Int32);
    val.responseType = decoder.decodeStruct(codec.Int32);
    val.alpnNegotiatedProtocol = decoder.decodeStruct(codec.String);
    ...
    val.urlListViaServiceWorker = decoder.decodeArrayPointer(new codec.PointerTo(url$.Url));
    val.serviceWorkerStartTime = decoder.decodeStructPointer(time$.TimeTicks);
    val.serviceWorkerReadyTime = decoder.decodeStructPointer(time$.TimeTicks);
    ...
    val.authChallengeInfo = decoder.decodeStructPointer(network_param$.AuthChallengeInfo);
    ...
    val.responseStart = decoder.decodeStructPointer(time$.TimeTicks);
    val.originPolicy = decoder.decodeStructPointer(origin_policy_manager$.OriginPolicy);
    val.recursivePrefetchToken = decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
    return val;
  };
  ...
  URLResponseHead.encode = function(encoder, val) {
    ...
    packed |= (val.isInCacheStorage & 1) << 7
    encoder.writeUint8(packed);
    packed = 0;
    packed |= (val.didServiceWorkerNavigationPreload & 1) << 0
    packed |= (val.shouldReportCorbBlocking & 1) << 1
