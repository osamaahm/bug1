...
(function() {
  ...
  CookieSameSiteContext.SAME_SITE_LAX_METHOD_UNSAFE = CookieSameSiteContext.CROSS_SITE + 1;
  CookieSameSiteContext.SAME_SITE_LAX = CookieSameSiteContext.SAME_SITE_LAX_METHOD_UNSAFE + 1;
  CookieSameSiteContext.SAME_SITE_STRICT = CookieSameSiteContext.SAME_SITE_LAX + 1;
  CookieSameSiteContext.SAME_SITE_LAX_METHOD_UNSAFE_CROSS_SCHEME_SECURE_URL = CookieSameSiteContext.SAME_SITE_STRICT + 1;
  CookieSameSiteContext.SAME_SITE_LAX_CROSS_SCHEME_SECURE_URL = CookieSameSiteContext.SAME_SITE_LAX_METHOD_UNSAFE_CROSS_SCHEME_SECURE_URL + 1;
  CookieSameSiteContext.SAME_SITE_STRICT_CROSS_SCHEME_SECURE_URL = CookieSameSiteContext.SAME_SITE_LAX_CROSS_SCHEME_SECURE_URL + 1;
  CookieSameSiteContext.SAME_SITE_LAX_METHOD_UNSAFE_CROSS_SCHEME_INSECURE_URL = CookieSameSiteContext.SAME_SITE_STRICT_CROSS_SCHEME_SECURE_URL + 1;
  CookieSameSiteContext.SAME_SITE_LAX_CROSS_SCHEME_INSECURE_URL = CookieSameSiteContext.SAME_SITE_LAX_METHOD_UNSAFE_CROSS_SCHEME_INSECURE_URL + 1;
  CookieSameSiteContext.SAME_SITE_STRICT_CROSS_SCHEME_INSECURE_URL = CookieSameSiteContext.SAME_SITE_LAX_CROSS_SCHEME_INSECURE_URL + 1;
  CookieSameSiteContext.MIN_VALUE = 0,
  CookieSameSiteContext.MAX_VALUE = 9,
  ...
  CookieAccessSemantics.LEGACY = CookieAccessSemantics.NONLEGACY + 1;
  ...
  var CookieInclusionStatusWarningReason = {};
  CookieInclusionStatusWarningReason.DO_NOT_WARN = 0;
  CookieInclusionStatusWarningReason.WARN_SAMESITE_UNSPECIFIED_CROSS_SITE_CONTEXT = CookieInclusionStatusWarningReason.DO_NOT_WARN + 1;
  CookieInclusionStatusWarningReason.WARN_SAMESITE_NONE_INSECURE = CookieInclusionStatusWarningReason.WARN_SAMESITE_UNSPECIFIED_CROSS_SITE_CONTEXT + 1;
  CookieInclusionStatusWarningReason.WARN_SAMESITE_UNSPECIFIED_LAX_ALLOW_UNSAFE = CookieInclusionStatusWarningReason.WARN_SAMESITE_NONE_INSECURE + 1;
  CookieInclusionStatusWarningReason.MIN_VALUE = 0,
  CookieInclusionStatusWarningReason.MAX_VALUE = 3,

  CookieInclusionStatusWarningReason.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  CookieInclusionStatusWarningReason.validate = function(enumValue) {
    var isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  CookieManagerParams.encodedSize = codec.kStructHeaderSize + 48;
  ...
  CookieManagerParams.decode = function(decoder) {
    ...
    val.settingsForLegacyCookieAccess = decoder.decodeArrayPointer(new codec.PointerTo(content_settings$.ContentSettingPatternSource));
    return val;
  };
  ...
  CookieOptions.encodedSize = codec.kStructHeaderSize + 8;
  ...
  CookieInclusionStatus.validate = function(messageValidator, offset) {
    ...
    // validate CookieInclusionStatus.warning
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 4, CookieInclusionStatusWarningReason);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieInclusionStatus.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.exclusionReasons = decoder.decodeStruct(codec.Uint32);
    val.warning = decoder.decodeStruct(codec.Int32);
    return val;
  };
  ...
  CookieInclusionStatus.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.warning);
  };
  ...
  CookieWithStatus.decode = function(decoder) {
    ...
    val.status = decoder.decodeStructPointer(CookieInclusionStatus);
    return val;
  };
  ...
  CookieAndLineWithStatus.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, CookieInclusionStatus, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManager_GetAllCookiesWithAccessSemantics_ResponseParams.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.cookies = decoder.decodeArrayPointer(new codec.PointerTo(CanonicalCookie));
    val.accessSemanticsList = decoder.decodeArrayPointer(new codec.Enum(CookieAccessSemantics));
    return val;
  };
  ...
  CookieManager_GetCookieList_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(CookieWithStatus), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManager_GetCookieList_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.cookies = decoder.decodeArrayPointer(new codec.PointerTo(CookieWithStatus));
  ...
  CookieManager_GetCookieList_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(CookieWithStatus), val.cookies);
  ...
  CookieManager_SetCanonicalCookie_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, CookieInclusionStatus, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kCookieManager_AddCookieChangeListener_Name = 6;
  var kCookieManager_AddGlobalChangeListener_Name = 7;
  var kCookieManager_CloneInterface_Name = 8;
  var kCookieManager_FlushCookieStore_Name = 9;
  var kCookieManager_AllowFileSchemeCookies_Name = 10;
  var kCookieManager_SetContentSettings_Name = 11;
  var kCookieManager_SetForceKeepSessionState_Name = 12;
  var kCookieManager_BlockThirdPartyCookies_Name = 13;
  var kCookieManager_SetContentSettingsForLegacyCookieAccess_Name = 14;
  ...
  exports.CookieInclusionStatusWarningReason = CookieInclusionStatusWarningReason;
