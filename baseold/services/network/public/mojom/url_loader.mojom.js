...
(function() {
  ...
  var UpdateNetworkIsolationKeyOnRedirect = {};
  UpdateNetworkIsolationKeyOnRedirect.kDoNotUpdate = 0;
  UpdateNetworkIsolationKeyOnRedirect.kUpdateTopFrameAndFrameOrigin = UpdateNetworkIsolationKeyOnRedirect.kDoNotUpdate + 1;
  UpdateNetworkIsolationKeyOnRedirect.kUpdateFrameOrigin = UpdateNetworkIsolationKeyOnRedirect.kUpdateTopFrameAndFrameOrigin + 1;
  UpdateNetworkIsolationKeyOnRedirect.MIN_VALUE = 0,
  UpdateNetworkIsolationKeyOnRedirect.MAX_VALUE = 2,

  UpdateNetworkIsolationKeyOnRedirect.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  UpdateNetworkIsolationKeyOnRedirect.validate = function(enumValue) {
    var isExtensible = false;
    if (isExtensible || this.isKnownEnumValue(enumValue))
      return validator.validationError.NONE;
  ...
  TrustedUrlRequestParams.prototype.initDefaults_ = function() {
    ...
    this.updateNetworkIsolationKeyOnRedirect = 0;
  };
  ...
  TrustedUrlRequestParams.validate = function(messageValidator, offset) {
    ...
    // validate TrustedUrlRequestParams.networkIsolationKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, network_isolation_key$.NetworkIsolationKey, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate TrustedUrlRequestParams.updateNetworkIsolationKeyOnRedirect
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, UpdateNetworkIsolationKeyOnRedirect);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  TrustedUrlRequestParams.encodedSize = codec.kStructHeaderSize + 16;
  ...
  TrustedUrlRequestParams.decode = function(decoder) {
    ...
    val.updateNetworkIsolationKeyOnRedirect = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  TrustedUrlRequestParams.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.updateNetworkIsolationKeyOnRedirect);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  URLRequest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 144, http_request_headers$.HttpRequestHeaders, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 160, unguessable_token$.UnguessableToken, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLRequest.encodedSize = codec.kStructHeaderSize + 192;
  ...
  URLRequest.decode = function(decoder) {
    ...
    val.isolatedWorldOrigin = decoder.decodeStructPointer(origin$.Origin);
    ...
    val.trustedParams = decoder.decodeStructPointer(TrustedUrlRequestParams);
  ...
  var kURLLoader_PauseReadingBodyFromNet_Name = 2;
  var kURLLoader_ResumeReadingBodyFromNet_Name = 3;
  ...
  exports.UpdateNetworkIsolationKeyOnRedirect = UpdateNetworkIsolationKeyOnRedirect;
