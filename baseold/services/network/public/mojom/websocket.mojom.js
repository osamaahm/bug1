...
(function() {
  ...
  WebSocketHandshakeClient_OnConnectionEstablished_Params.validate = function(messageValidator, offset) {
    ...
    // validate WebSocketHandshakeClient_OnConnectionEstablished_Params.selectedProtocol
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 16, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate WebSocketHandshakeClient_OnConnectionEstablished_Params.extensions
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 24, false)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 32, WebSocketHandshakeResponse, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebSocketHandshakeClient_OnConnectionEstablished_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  WebSocketHandshakeClient_OnConnectionEstablished_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.socket = decoder.decodeStruct(new codec.Interface(WebSocketPtr));
    val.clientReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    val.readable = decoder.decodeStruct(codec.Handle);
  ...
  function WebSocketClient_AddSendFlowControlQuota_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  WebSocketClient_AddSendFlowControlQuota_Params.prototype.initDefaults_ = function() {
    this.quota = 0;
  };
  WebSocketClient_AddSendFlowControlQuota_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  WebSocketClient_AddSendFlowControlQuota_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebSocketClient_AddSendFlowControlQuota_Params.encodedSize = codec.kStructHeaderSize + 8;

  WebSocketClient_AddSendFlowControlQuota_Params.decode = function(decoder) {
    var packed;
    var val = new WebSocketClient_AddSendFlowControlQuota_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  WebSocketClient_AddSendFlowControlQuota_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(WebSocketClient_AddSendFlowControlQuota_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  var kWebSocketHandshakeClient_OnConnectionEstablished_Name = 1;
  ...
  WebSocketHandshakeClientProxy.prototype.onConnectionEstablished = function(socket, clientReceiver, selectedProtocol, extensions, response, readable) {
  ...
  WebSocketHandshakeClientStub.prototype.onConnectionEstablished = function(socket, clientReceiver, selectedProtocol, extensions, response, readable) {
    return this.delegate_ && this.delegate_.onConnectionEstablished && this.delegate_.onConnectionEstablished(socket, clientReceiver, selectedProtocol, extensions, response, readable);
  }
  ...
  WebSocketHandshakeClientStub.prototype.accept = function(message) {
    ...
    case kWebSocketHandshakeClient_OnConnectionEstablished_Name:
      ...
      this.onConnectionEstablished(params.socket, params.clientReceiver, params.selectedProtocol, params.extensions, params.response, params.readable);
      return true;
    default:
      return false;
    }
  ...
  var kWebSocketClient_AddSendFlowControlQuota_Name = 1;
  var kWebSocketClient_OnDropChannel_Name = 2;
  var kWebSocketClient_OnClosingHandshake_Name = 3;
  ...
  WebSocketClientPtr.prototype.addSendFlowControlQuota = function() {
    return WebSocketClientProxy.prototype.addSendFlowControlQuota
        .apply(this.ptr.getProxy(), arguments);
  };

  WebSocketClientProxy.prototype.addSendFlowControlQuota = function(quota) {
    var params_ = new WebSocketClient_AddSendFlowControlQuota_Params();
    params_.quota = quota;
    var builder = new codec.MessageV0Builder(
        kWebSocketClient_AddSendFlowControlQuota_Name,
        codec.align(WebSocketClient_AddSendFlowControlQuota_Params.encodedSize));
    builder.encodeStruct(WebSocketClient_AddSendFlowControlQuota_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  WebSocketClientStub.prototype.addSendFlowControlQuota = function(quota) {
    return this.delegate_ && this.delegate_.addSendFlowControlQuota && this.delegate_.addSendFlowControlQuota(quota);
  }
  ...
  WebSocketClientStub.prototype.accept = function(message) {
    ...
    case kWebSocketClient_OnDataFrame_Name:
      ...
      return true;
    case kWebSocketClient_AddSendFlowControlQuota_Name:
      var params = reader.decodeStruct(WebSocketClient_AddSendFlowControlQuota_Params);
      this.addSendFlowControlQuota(params.quota);
      return true;
  ...
  function validateWebSocketClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kWebSocketClient_AddSendFlowControlQuota_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = WebSocketClient_AddSendFlowControlQuota_Params;
      break;
      case kWebSocketClient_OnDropChannel_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  var kWebSocket_SendFrame_Name = 0;
  ...
  WebSocket.INSUFFICIENT_RESOURCES = 1,
  WebSocket.INTERNAL_FAILURE = 2,
