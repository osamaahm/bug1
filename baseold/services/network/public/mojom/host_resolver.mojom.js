...
(function() {
  ...
  var SecureDnsMode = {};
  SecureDnsMode.OFF = 0;
  SecureDnsMode.AUTOMATIC = SecureDnsMode.OFF + 1;
  SecureDnsMode.SECURE = SecureDnsMode.AUTOMATIC + 1;
  ...
  DnsConfigOverrides.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 68, DnsConfigOverrides.Tristate);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DnsConfigOverrides.encodedSize = codec.kStructHeaderSize + 80;
  ...
  DnsConfigOverrides.decode = function(decoder) {
    ...
    val.allowDnsOverHttpsUpgrade = decoder.decodeStruct(codec.Int32);
    val.disabledUpgradeProviders = decoder.decodeArrayPointer(codec.String);
    return val;
  };
  ...
  DnsConfigChangeManager_RequestNotifications_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.client = decoder.decodeStruct(new codec.Interface(DnsConfigChangeManagerClientPtr));
    return val;
  };
