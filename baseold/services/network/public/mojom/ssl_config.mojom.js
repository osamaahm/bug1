...
(function() {
  ...
  SSLConfig.prototype.initDefaults_ = function() {
    ...
    this.tls13HardeningForLocalAnchorsEnabled = false;
  ...
  SSLConfig.decode = function(decoder) {
    ...
    val.tls13HardeningForLocalAnchorsEnabled = (packed >> 4) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  SSLConfig.encode = function(encoder, val) {
    ...
    packed |= (val.tls13HardeningForLocalAnchorsEnabled & 1) << 4
