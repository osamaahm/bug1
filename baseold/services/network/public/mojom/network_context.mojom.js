...
(function() {
  ...
  var INVALID_PROCESS_ID = 0xffffffff;
  var CrossOriginEmbedderPolicy = {};
  CrossOriginEmbedderPolicy.kNone = 0;
  CrossOriginEmbedderPolicy.kRequireCorp = CrossOriginEmbedderPolicy.kNone + 1;
  CrossOriginEmbedderPolicy.MIN_VALUE = 0,
  CrossOriginEmbedderPolicy.MAX_VALUE = 1,

  CrossOriginEmbedderPolicy.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
      return true;
  ...
  CrossOriginEmbedderPolicy.validate = function(enumValue) {
  ...
  NetworkContextParams.prototype.initDefaults_ = function() {
    ...
    this.corsExtraSafelistedRequestHeaderNames = null;
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContextParams.allowDefaultCredentials
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 80, default_credentials$.DefaultCredentials);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 84, true)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 104, true)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 108, true)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 144, time$.Time, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.cookieManagerParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 152, cookie_manager$.CookieManagerParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 168, time$.TimeDelta, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 176, 8, new codec.PointerTo(cors_origin_pattern$.CorsOriginAccessPatterns), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextParams.corsExtraSafelistedRequestHeaderNames
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 208, file_path$.FilePath, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.encodedSize = codec.kStructHeaderSize + 216;
  ...
  NetworkContextParams.decode = function(decoder) {
    ...
    val.disableIdleSocketsCloseOnMemoryPressure = (packed >> 1) & 1 ? true : false;
    ...
    val.enableExpectCtReporting = (packed >> 5) & 1 ? true : false;
    ...
    val.primaryNetworkContext = (packed >> 1) & 1 ? true : false;
    val.enableCors = (packed >> 2) & 1 ? true : false;
    decoder.skip(1);
    ...
    val.allowDefaultCredentials = decoder.decodeStruct(codec.Int32);
    val.sslConfigClientReceiver = decoder.decodeStruct(codec.NullableInterfaceRequest);
    ...
    val.proxyConfigClientReceiver = decoder.decodeStruct(codec.NullableInterfaceRequest);
    val.customProxyConfigClientReceiver = decoder.decodeStruct(codec.NullableInterfaceRequest);
    ...
    val.ctLogUpdateTime = decoder.decodeStructPointer(time$.Time);
    ...
    val.hstsPolicyBypassList = decoder.decodeArrayPointer(codec.String);
    val.corsExtraSafelistedRequestHeaderNames = decoder.decodeArrayPointer(codec.String);
    val.reportingAndNelStorePath = decoder.decodeStructPointer(file_path$.FilePath);
    return val;
  };
  ...
  NetworkContextParams.encode = function(encoder, val) {
    ...
    packed |= (val.primaryNetworkContext & 1) << 1
    packed |= (val.enableCors & 1) << 2
    encoder.writeUint8(packed);
    encoder.skip(1);
    ...
    encoder.encodeArrayPointer(codec.String, val.corsExtraSafelistedRequestHeaderNames);
  ...
  URLLoaderFactoryParams.prototype.initDefaults_ = function() {
    ...
    this.crossOriginEmbedderPolicy = CrossOriginEmbedderPolicy.kNone;
  ...
  URLLoaderFactoryParams.validate = function(messageValidator, offset) {
    ...
    // validate URLLoaderFactoryParams.crossOriginEmbedderPolicy
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 16, CrossOriginEmbedderPolicy);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 32, 8, new codec.PointerTo(cors_origin_pattern$.CorsOriginPattern), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate URLLoaderFactoryParams.networkIsolationKey
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 40, network_isolation_key$.NetworkIsolationKey, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderFactoryParams.encodedSize = codec.kStructHeaderSize + 48;
  ...
  URLLoaderFactoryParams.decode = function(decoder) {
    ...
    val.isTrusted = (packed >> 2) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.requestInitiatorSiteLock = decoder.decodeStructPointer(origin$.Origin);
    val.crossOriginEmbedderPolicy = decoder.decodeStruct(codec.Int32);
    ...
    val.networkIsolationKey = decoder.decodeStructPointer(network_isolation_key$.NetworkIsolationKey);
    return val;
  };
  ...
  URLLoaderFactoryParams.encode = function(encoder, val) {
    ...
    packed |= (val.isTrusted & 1) << 2
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStructPointer(origin$.Origin, val.requestInitiatorSiteLock);
    encoder.encodeStruct(codec.Int32, val.crossOriginEmbedderPolicy);
  ...
  NetworkContextClient_OnAuthRequired_Params.decode = function(decoder) {
    ...
    val.head = decoder.decodeStructPointer(url_response_head$.URLResponseHead);
  ...
  function NetworkContextClient_OnCookiesChanged_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkContextClient_OnCookiesChanged_Params.prototype.initDefaults_ = function() {
  ...
  NetworkContextClient_OnCookiesChanged_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContextClient_OnCookiesChanged_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextClient_OnCookiesChanged_Params.url
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextClient_OnCookiesChanged_Params.siteForCookies
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextClient_OnCookiesChanged_Params.cookieList
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 32, 8, new codec.PointerTo(cookie_manager$.CookieWithStatus), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextClient_OnCookiesChanged_Params.encodedSize = codec.kStructHeaderSize + 40;

  NetworkContextClient_OnCookiesChanged_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContextClient_OnCookiesChanged_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    val.isServiceWorker = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    ...
    val.cookieList = decoder.decodeArrayPointer(new codec.PointerTo(cookie_manager$.CookieWithStatus));
    return val;
  };

  NetworkContextClient_OnCookiesChanged_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContextClient_OnCookiesChanged_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
    packed |= (val.isServiceWorker & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(cookie_manager$.CookieWithStatus), val.cookieList);
  };
  function NetworkContextClient_OnCookiesRead_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkContextClient_OnCookiesRead_Params.prototype.initDefaults_ = function() {
    this.isServiceWorker = false;
    this.processId = 0;
    this.routingId = 0;
    this.url = null;
  ...
  NetworkContextClient_OnCookiesRead_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContextClient_OnCookiesRead_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextClient_OnCookiesRead_Params.url
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextClient_OnCookiesRead_Params.siteForCookies
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextClient_OnCookiesRead_Params.cookieList
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 32, 8, new codec.PointerTo(cookie_manager$.CookieWithStatus), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextClient_OnCookiesRead_Params.encodedSize = codec.kStructHeaderSize + 40;

  NetworkContextClient_OnCookiesRead_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContextClient_OnCookiesRead_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    val.isServiceWorker = (packed >> 0) & 1 ? true : false;
  ...
  NetworkContextClient_OnCookiesRead_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContextClient_OnCookiesRead_Params.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
    packed |= (val.isServiceWorker & 1) << 0
    encoder.writeUint8(packed);
  ...
  function NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.prototype.initDefaults_ = function() {
    this.serverAuthToken = null;
    this.canDelegate = false;
    this.authNegotiateAndroidAccountType = null;
    this.spn = null;
  };
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.serverAuthToken
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.authNegotiateAndroidAccountType
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 16, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.spn
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.encodedSize = codec.kStructHeaderSize + 32;

  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  function NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.prototype.initDefaults_ = function() {
    this.result = 0;
    this.authToken = null;
  };
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.authToken
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.encodedSize = codec.kStructHeaderSize + 16;

  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.result = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
  ...
  NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.Int32, val.result);
    encoder.skip(1);
    encoder.skip(1);
  ...
  NetworkContext_GetRestrictedCookieManager_Params.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContext_GetRestrictedCookieManager_Params.siteForCookies
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContext_GetRestrictedCookieManager_Params.topFrameOrigin
  ...
  NetworkContext_NotifyExternalCacheHit_Params.decode = function(decoder) {
    ...
    val.key = decoder.decodeStructPointer(network_isolation_key$.NetworkIsolationKey);
    return val;
  };
  ...
  NetworkContext_CreateUDPSocket_Params.decode = function(decoder) {
    ...
    val.listener = decoder.decodeStruct(new codec.NullableInterface(udp_socket$.UDPSocketListenerPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  NetworkContext_CreateWebSocket_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 24, 8, new codec.PointerTo(websocket$.HttpHeader), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 52, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContext_CreateWebSocket_Params.authHandler
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 60, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_CreateWebSocket_Params.encodedSize = codec.kStructHeaderSize + 80;
  ...
  NetworkContext_CreateWebSocket_Params.decode = function(decoder) {
    ...
    val.siteForCookies = decoder.decodeStructPointer(url$.Url);
    val.additionalHeaders = decoder.decodeArrayPointer(new codec.PointerTo(websocket$.HttpHeader));
    val.processId = decoder.decodeStruct(codec.Int32);
  ...
  NetworkContext_CreateMdnsResponder_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.responderReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  function NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.prototype.initDefaults_ = function() {
    this.corsExtraSafelistedRequestHeaderNames = null;
  };
  NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.corsExtraSafelistedRequestHeaderNames
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, codec.String, false, [0, 0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.encodedSize = codec.kStructHeaderSize + 8;

  NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.decode = function(decoder) {
    var packed;
    var val = new NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.corsExtraSafelistedRequestHeaderNames = decoder.decodeArrayPointer(codec.String);
    return val;
  ...
  NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(codec.String, val.corsExtraSafelistedRequestHeaderNames);
  };
  ...
  NetworkContext_AddAuthCacheEntry_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, network_param$.AuthCredentials, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_AddAuthCacheEntry_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  NetworkContext_AddAuthCacheEntry_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.challenge = decoder.decodeStructPointer(network_param$.AuthChallengeInfo);
    val.credentials = decoder.decodeStructPointer(network_param$.AuthCredentials);
    return val;
  };
  ...
  var kNetworkContextClient_OnAuthRequired_Name = 0;
  var kNetworkContextClient_OnCertificateRequested_Name = 1;
  var kNetworkContextClient_OnSSLCertificateError_Name = 2;
  var kNetworkContextClient_OnFileUploadRequested_Name = 3;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 4;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 5;
  var kNetworkContextClient_OnClearSiteData_Name = 6;
  var kNetworkContextClient_OnCookiesChanged_Name = 7;
  var kNetworkContextClient_OnCookiesRead_Name = 8;
  var kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name = 9;
  ...
  NetworkContextClientPtr.prototype.onCookiesChanged = function() {
    return NetworkContextClientProxy.prototype.onCookiesChanged
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextClientProxy.prototype.onCookiesChanged = function(isServiceWorker, processId, routingId, url, siteForCookies, cookieList) {
    var params_ = new NetworkContextClient_OnCookiesChanged_Params();
    params_.isServiceWorker = isServiceWorker;
    params_.processId = processId;
    params_.routingId = routingId;
    params_.url = url;
    ...
    var builder = new codec.MessageV0Builder(
        kNetworkContextClient_OnCookiesChanged_Name,
        codec.align(NetworkContextClient_OnCookiesChanged_Params.encodedSize));
    builder.encodeStruct(NetworkContextClient_OnCookiesChanged_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  NetworkContextClientPtr.prototype.onCookiesRead = function() {
    return NetworkContextClientProxy.prototype.onCookiesRead
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextClientProxy.prototype.onCookiesRead = function(isServiceWorker, processId, routingId, url, siteForCookies, cookieList) {
    var params_ = new NetworkContextClient_OnCookiesRead_Params();
    params_.isServiceWorker = isServiceWorker;
    params_.processId = processId;
    params_.routingId = routingId;
    params_.url = url;
    ...
    params_.cookieList = cookieList;
    var builder = new codec.MessageV0Builder(
        kNetworkContextClient_OnCookiesRead_Name,
        codec.align(NetworkContextClient_OnCookiesRead_Params.encodedSize));
    builder.encodeStruct(NetworkContextClient_OnCookiesRead_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  NetworkContextClientPtr.prototype.onGenerateHttpNegotiateAuthToken = function() {
    return NetworkContextClientProxy.prototype.onGenerateHttpNegotiateAuthToken
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextClientProxy.prototype.onGenerateHttpNegotiateAuthToken = function(serverAuthToken, canDelegate, authNegotiateAndroidAccountType, spn) {
    var params_ = new NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params();
    ...
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name,
          codec.align(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  NetworkContextClientStub.prototype.onCookiesChanged = function(isServiceWorker, processId, routingId, url, siteForCookies, cookieList) {
    return this.delegate_ && this.delegate_.onCookiesChanged && this.delegate_.onCookiesChanged(isServiceWorker, processId, routingId, url, siteForCookies, cookieList);
  }
  NetworkContextClientStub.prototype.onCookiesRead = function(isServiceWorker, processId, routingId, url, siteForCookies, cookieList) {
    return this.delegate_ && this.delegate_.onCookiesRead && this.delegate_.onCookiesRead(isServiceWorker, processId, routingId, url, siteForCookies, cookieList);
  }
  NetworkContextClientStub.prototype.onGenerateHttpNegotiateAuthToken = function(serverAuthToken, canDelegate, authNegotiateAndroidAccountType, spn) {
  ...
  NetworkContextClientStub.prototype.accept = function(message) {
    ...
    case kNetworkContextClient_OnCertificateRequested_Name:
      ...
      return true;
    case kNetworkContextClient_OnCookiesChanged_Name:
      var params = reader.decodeStruct(NetworkContextClient_OnCookiesChanged_Params);
      this.onCookiesChanged(params.isServiceWorker, params.processId, params.routingId, params.url, params.siteForCookies, params.cookieList);
      return true;
    case kNetworkContextClient_OnCookiesRead_Name:
      var params = reader.decodeStruct(NetworkContextClient_OnCookiesRead_Params);
      this.onCookiesRead(params.isServiceWorker, params.processId, params.routingId, params.url, params.siteForCookies, params.cookieList);
      return true;
    default:
      return false;
    }
  ...
  NetworkContextClientStub.prototype.acceptWithResponder =
    ...
    case kNetworkContextClient_OnClearSiteData_Name:
      ...
      return true;
    case kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name:
      var params = reader.decodeStruct(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params);
      this.onGenerateHttpNegotiateAuthToken(params.serverAuthToken, params.canDelegate, params.authNegotiateAndroidAccountType, params.spn).then(function(response) {
        var responseParams =
            new NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams();
        responseParams.result = response.result;
        responseParams.authToken = response.authToken;
        var builder = new codec.MessageV1Builder(
            kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name,
            codec.align(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateNetworkContextClientRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkContextClient_OnCookiesChanged_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkContextClient_OnCookiesChanged_Params;
      break;
      case kNetworkContextClient_OnCookiesRead_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkContextClient_OnCookiesRead_Params;
      break;
      case kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name:
        if (message.expectsResponse())
          paramsClass = NetworkContextClient_OnGenerateHttpNegotiateAuthToken_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateNetworkContextClientResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kNetworkContextClient_OnGenerateHttpNegotiateAuthToken_Name:
        if (message.isResponse())
          paramsClass = NetworkContextClient_OnGenerateHttpNegotiateAuthToken_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  var kNetworkContext_ClearHostCache_Name = 9;
  var kNetworkContext_ClearHttpAuthCache_Name = 10;
  var kNetworkContext_ClearReportingCacheReports_Name = 11;
  var kNetworkContext_ClearReportingCacheClients_Name = 12;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 13;
  var kNetworkContext_ClearDomainReliability_Name = 14;
  var kNetworkContext_GetDomainReliabilityJSON_Name = 15;
  var kNetworkContext_QueueReport_Name = 16;
  var kNetworkContext_QueueSignedExchangeReport_Name = 17;
  var kNetworkContext_CloseAllConnections_Name = 18;
  var kNetworkContext_CloseIdleConnections_Name = 19;
  var kNetworkContext_SetNetworkConditions_Name = 20;
  var kNetworkContext_SetAcceptLanguage_Name = 21;
  var kNetworkContext_SetEnableReferrers_Name = 22;
  var kNetworkContext_SetCTPolicy_Name = 23;
  var kNetworkContext_AddExpectCT_Name = 24;
  var kNetworkContext_SetExpectCTTestReport_Name = 25;
  var kNetworkContext_GetExpectCTState_Name = 26;
  var kNetworkContext_CreateUDPSocket_Name = 27;
  var kNetworkContext_CreateTCPServerSocket_Name = 28;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 29;
  var kNetworkContext_CreateTCPBoundSocket_Name = 30;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 31;
  var kNetworkContext_LookUpProxyForURL_Name = 32;
  var kNetworkContext_ForceReloadProxyConfig_Name = 33;
  var kNetworkContext_ClearBadProxiesCache_Name = 34;
  var kNetworkContext_CreateWebSocket_Name = 35;
  var kNetworkContext_CreateNetLogExporter_Name = 36;
  var kNetworkContext_PreconnectSockets_Name = 37;
  var kNetworkContext_CreateP2PSocketManager_Name = 38;
  var kNetworkContext_CreateMdnsResponder_Name = 39;
  var kNetworkContext_ResolveHost_Name = 40;
  var kNetworkContext_CreateHostResolver_Name = 41;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 42;
  var kNetworkContext_AddHSTS_Name = 43;
  var kNetworkContext_IsHSTSActiveForHost_Name = 44;
  var kNetworkContext_GetHSTSState_Name = 45;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 46;
  var kNetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Name = 47;
  ...
  var kNetworkContext_AddAuthCacheEntry_Name = 51;
  var kNetworkContext_LookupBasicAuthCredentials_Name = 52;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 53;
  var kNetworkContext_SetFailingHttpTransactionForTesting_Name = 54;
  var kNetworkContext_VerifyCertificateForTesting_Name = 55;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 56;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 57;
  var kNetworkContext_GetOriginPolicyManager_Name = 58;
  ...
  NetworkContextProxy.prototype.getRestrictedCookieManager = function(restrictedCookieManager, role, origin, siteForCookies, topFrameOrigin, isServiceWorker, processId, routingId) {
  ...
  NetworkContextProxy.prototype.notifyExternalCacheHit = function(url, httpMethod, key) {
  ...
  NetworkContextProxy.prototype.createWebSocket = function(url, requestedProtocols, siteForCookies, additionalHeaders, processId, renderFrameId, origin, options, handshakeClient, authHandler, headerClient) {
  ...
  NetworkContextPtr.prototype.setCorsExtraSafelistedRequestHeaderNames = function() {
    return NetworkContextProxy.prototype.setCorsExtraSafelistedRequestHeaderNames
        .apply(this.ptr.getProxy(), arguments);
  };

  NetworkContextProxy.prototype.setCorsExtraSafelistedRequestHeaderNames = function(corsExtraSafelistedRequestHeaderNames) {
    var params_ = new NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params();
    params_.corsExtraSafelistedRequestHeaderNames = corsExtraSafelistedRequestHeaderNames;
    var builder = new codec.MessageV0Builder(
        kNetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Name,
        codec.align(NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params.encodedSize));
    builder.encodeStruct(NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  NetworkContextProxy.prototype.addAuthCacheEntry = function(challenge, credentials) {
  ...
  NetworkContextStub.prototype.getRestrictedCookieManager = function(restrictedCookieManager, role, origin, siteForCookies, topFrameOrigin, isServiceWorker, processId, routingId) {
    return this.delegate_ && this.delegate_.getRestrictedCookieManager && this.delegate_.getRestrictedCookieManager(restrictedCookieManager, role, origin, siteForCookies, topFrameOrigin, isServiceWorker, processId, routingId);
  }
  ...
  NetworkContextStub.prototype.notifyExternalCacheHit = function(url, httpMethod, key) {
    return this.delegate_ && this.delegate_.notifyExternalCacheHit && this.delegate_.notifyExternalCacheHit(url, httpMethod, key);
  }
  ...
  NetworkContextStub.prototype.createWebSocket = function(url, requestedProtocols, siteForCookies, additionalHeaders, processId, renderFrameId, origin, options, handshakeClient, authHandler, headerClient) {
    return this.delegate_ && this.delegate_.createWebSocket && this.delegate_.createWebSocket(url, requestedProtocols, siteForCookies, additionalHeaders, processId, renderFrameId, origin, options, handshakeClient, authHandler, headerClient);
  }
  ...
  NetworkContextStub.prototype.setCorsExtraSafelistedRequestHeaderNames = function(corsExtraSafelistedRequestHeaderNames) {
    return this.delegate_ && this.delegate_.setCorsExtraSafelistedRequestHeaderNames && this.delegate_.setCorsExtraSafelistedRequestHeaderNames(corsExtraSafelistedRequestHeaderNames);
  }
  ...
  NetworkContextStub.prototype.addAuthCacheEntry = function(challenge, credentials) {
    return this.delegate_ && this.delegate_.addAuthCacheEntry && this.delegate_.addAuthCacheEntry(challenge, credentials);
  }
  ...
  NetworkContextStub.prototype.accept = function(message) {
    ...
    case kNetworkContext_GetRestrictedCookieManager_Name:
      ...
      this.getRestrictedCookieManager(params.restrictedCookieManager, params.role, params.origin, params.siteForCookies, params.topFrameOrigin, params.isServiceWorker, params.processId, params.routingId);
      return true;
    case kNetworkContext_NotifyExternalCacheHit_Name:
      ...
      this.notifyExternalCacheHit(params.url, params.httpMethod, params.key);
      return true;
    ...
    case kNetworkContext_CreateWebSocket_Name:
      ...
      this.createWebSocket(params.url, params.requestedProtocols, params.siteForCookies, params.additionalHeaders, params.processId, params.renderFrameId, params.origin, params.options, params.handshakeClient, params.authHandler, params.headerClient);
      return true;
    ...
    case kNetworkContext_CreateHostResolver_Name:
      ...
      return true;
    case kNetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Name:
      var params = reader.decodeStruct(NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params);
      this.setCorsExtraSafelistedRequestHeaderNames(params.corsExtraSafelistedRequestHeaderNames);
      return true;
  ...
  NetworkContextStub.prototype.acceptWithResponder =
    ...
    case kNetworkContext_AddAuthCacheEntry_Name:
      ...
      this.addAuthCacheEntry(params.challenge, params.credentials).then(function(response) {
        var responseParams =
  ...
  function validateNetworkContextRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kNetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = NetworkContext_SetCorsExtraSafelistedRequestHeaderNames_Params;
      break;
      case kNetworkContext_DeleteDynamicDataForHost_Name:
        if (message.expectsResponse())
