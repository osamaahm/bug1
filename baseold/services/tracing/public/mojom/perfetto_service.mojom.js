...
(function() {
  ...
  var PERFETTO_PRODUCER_NAME_PREFIX = "org.chromium.perfetto_producer.";
  ...
  BufferFillPolicy.kRingBuffer = BufferFillPolicy.kUnspecified + 1;
  BufferFillPolicy.kDiscard = BufferFillPolicy.kRingBuffer + 1;
  ...
  TracingClientPriority.kBackground = TracingClientPriority.kUnknown + 1;
  TracingClientPriority.kUserInitiated = TracingClientPriority.kBackground + 1;
  ...
  DataSourceConfig.encodedSize = codec.kStructHeaderSize + 40;
  ...
  DataSourceConfig.decode = function(decoder) {
    ...
    val.targetBuffer = decoder.decodeStruct(codec.Uint32);
    val.traceDurationMs = decoder.decodeStruct(codec.Uint32);
    val.tracingSessionId = decoder.decodeStruct(codec.Uint64);
    val.chromeConfig = decoder.decodeStructPointer(ChromeConfig);
    val.legacyConfig = decoder.decodeStruct(codec.String);
    return val;
  };
  ...
  BufferConfig.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.sizeKb = decoder.decodeStruct(codec.Uint32);
    val.fillPolicy = decoder.decodeStruct(codec.Int32);
    return val;
  };
  ...
  DataSource.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.config = decoder.decodeStructPointer(DataSourceConfig);
    val.producerNameFilter = decoder.decodeArrayPointer(codec.String);
    return val;
  };
  ...
  IncrementalStateConfig.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.clearPeriodMs = decoder.decodeStruct(codec.Uint32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  TraceConfig.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.dataSources = decoder.decodeArrayPointer(new codec.PointerTo(DataSource));
    val.perfettoBuiltinDataSource = decoder.decodeStructPointer(PerfettoBuiltinDataSource);
    val.buffers = decoder.decodeArrayPointer(new codec.PointerTo(BufferConfig));
    val.incrementalStateConfig = decoder.decodeStructPointer(IncrementalStateConfig);
    val.durationMs = decoder.decodeStruct(codec.Uint32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ProducerHost_RegisterDataSource_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.registrationInfo = decoder.decodeStructPointer(DataSourceRegistration);
    return val;
  };
  ...
  ProducerClient_OnTracingStart_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  ProducerClient_OnTracingStart_Params.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.sharedMemoryBufferPageSizeBytes = decoder.decodeStruct(codec.Uint64);
    return val;
  };
  ...
  PerfettoService_ConnectToProducerHost_Params.decode = function(decoder) {
    ...
    val.producerHostReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ConsumerHost_EnableTracing_Params.validate = function(messageValidator, offset) {
    ...
    // validate ConsumerHost_EnableTracing_Params.priority
  ...
  ConsumerHost_EnableTracing_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  ConsumerHost_EnableTracing_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.tracingSessionHost = decoder.decodeStruct(codec.InterfaceRequest);
    val.tracingSessionClient = decoder.decodeStruct(new codec.Interface(TracingSessionClientPtr));
    val.priority = decoder.decodeStruct(codec.Int32);
    val.config = decoder.decodeStructPointer(TraceConfig);
    return val;
  };
  ...
  TracingSessionHost_DisableTracingAndEmitJson_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.agentLabelFilter = decoder.decodeStruct(codec.String);
    val.stream = decoder.decodeStruct(codec.Handle);
    packed = decoder.readUint8();
    val.privacyFilteringEnabled = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
  ...
  TracingSessionClient_OnTracingDisabled_Params.encodedSize = codec.kStructHeaderSize + 0;
  ...
  var kProducerHost_CommitData_Name = 0;
  var kProducerHost_RegisterDataSource_Name = 1;
  var kProducerHost_RegisterTraceWriter_Name = 2;
  var kProducerHost_UnregisterTraceWriter_Name = 3;
  ...
  var kProducerClient_OnTracingStart_Name = 0;
  var kProducerClient_StartDataSource_Name = 1;
  var kProducerClient_StopDataSource_Name = 2;
  var kProducerClient_Flush_Name = 3;
  var kProducerClient_ClearIncrementalState_Name = 4;
  ...
  ProducerClientProxy.prototype.onTracingStart = function(sharedMemory, sharedMemoryBufferPageSizeBytes) {
  ...
  ProducerClientStub.prototype.onTracingStart = function(sharedMemory, sharedMemoryBufferPageSizeBytes) {
    return this.delegate_ && this.delegate_.onTracingStart && this.delegate_.onTracingStart(sharedMemory, sharedMemoryBufferPageSizeBytes);
  }
  ...
  ProducerClientStub.prototype.accept = function(message) {
    ...
    case kProducerClient_OnTracingStart_Name:
      ...
      this.onTracingStart(params.sharedMemory, params.sharedMemoryBufferPageSizeBytes);
      return true;
  ...
  var kPerfettoService_ConnectToProducerHost_Name = 0;
  ...
  PerfettoServiceProxy.prototype.connectToProducerHost = function(producerClient, producerHostReceiver) {
  ...
  PerfettoServiceStub.prototype.connectToProducerHost = function(producerClient, producerHostReceiver) {
    return this.delegate_ && this.delegate_.connectToProducerHost && this.delegate_.connectToProducerHost(producerClient, producerHostReceiver);
  }
  ...
  PerfettoServiceStub.prototype.accept = function(message) {
    ...
    case kPerfettoService_ConnectToProducerHost_Name:
      ...
      this.connectToProducerHost(params.producerClient, params.producerHostReceiver);
      return true;
    default:
      return false;
    }
  ...
  var kConsumerHost_EnableTracing_Name = 0;
  ...
  ConsumerHostProxy.prototype.enableTracing = function(tracingSessionHost, tracingSessionClient, config, priority) {
  ...
  ConsumerHostStub.prototype.enableTracing = function(tracingSessionHost, tracingSessionClient, config, priority) {
    return this.delegate_ && this.delegate_.enableTracing && this.delegate_.enableTracing(tracingSessionHost, tracingSessionClient, config, priority);
  }
  ...
  ConsumerHostStub.prototype.accept = function(message) {
    ...
    case kConsumerHost_EnableTracing_Name:
      ...
      this.enableTracing(params.tracingSessionHost, params.tracingSessionClient, params.config, params.priority);
      return true;
    default:
      return false;
    }
  ...
  var kTracingSessionHost_ChangeTraceConfig_Name = 0;
  var kTracingSessionHost_DisableTracing_Name = 1;
  var kTracingSessionHost_ReadBuffers_Name = 2;
  var kTracingSessionHost_RequestBufferUsage_Name = 3;
  var kTracingSessionHost_DisableTracingAndEmitJson_Name = 4;
  ...
  var kTracingSessionClient_OnTracingEnabled_Name = 0;
  var kTracingSessionClient_OnTracingDisabled_Name = 1;
  ...
  TracingSessionClientProxy.prototype.onTracingDisabled = function() {
  ...
  TracingSessionClientStub.prototype.onTracingDisabled = function() {
    return this.delegate_ && this.delegate_.onTracingDisabled && this.delegate_.onTracingDisabled();
  }
