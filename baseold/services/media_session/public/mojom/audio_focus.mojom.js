...
(function() {
  ...
  AudioFocusManager_SetSource_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.identity = decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
  ...
  AudioFocusManager_AddSourceObserver_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.sourceId = decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
    val.observer = decoder.decodeStruct(new codec.Interface(AudioFocusObserverPtr));
    return val;
  };
  ...
  AudioFocusManagerProxy.prototype.requestGroupedAudioFocus = function(requestId, client, mediaSession, sessionInfo, type, groupId) {
  ...
  AudioFocusManagerStub.prototype.requestGroupedAudioFocus = function(requestId, client, mediaSession, sessionInfo, type, groupId) {
    return this.delegate_ && this.delegate_.requestGroupedAudioFocus && this.delegate_.requestGroupedAudioFocus(requestId, client, mediaSession, sessionInfo, type, groupId);
  }
  ...
  AudioFocusManagerStub.prototype.acceptWithResponder =
    ...
    case kAudioFocusManager_RequestGroupedAudioFocus_Name:
      ...
      this.requestGroupedAudioFocus(params.requestId, params.client, params.mediaSession, params.sessionInfo, params.type, params.groupId).then(function(response) {
        var responseParams =
