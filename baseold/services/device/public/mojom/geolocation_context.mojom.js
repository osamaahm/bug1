...
(function() {
  ...
  var kGeolocationContext_SetOverride_Name = 1;
  var kGeolocationContext_ClearOverride_Name = 2;
  ...
  GeolocationContextProxy.prototype.bindGeolocation = function(receiver) {
  ...
  GeolocationContextStub.prototype.bindGeolocation = function(receiver) {
    return this.delegate_ && this.delegate_.bindGeolocation && this.delegate_.bindGeolocation(receiver);
  }
  ...
  GeolocationContextStub.prototype.accept = function(message) {
    ...
    case kGeolocationContext_BindGeolocation_Name:
      ...
      this.bindGeolocation(params.receiver);
      return true;
