// services/device/public/mojom/usb_device.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  var mojomId = 'services/device/public/mojom/usb_device.mojom';
  ...
  UsbInterfaceInfo.decode = function(decoder) {
    ...
    val.firstInterface = decoder.decodeStruct(codec.Uint8);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  UsbInterfaceInfo.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Uint8, val.firstInterface);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
