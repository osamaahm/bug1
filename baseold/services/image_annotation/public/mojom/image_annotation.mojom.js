...
(function() {
  ...
  AnnotateImageError.kFailure = AnnotateImageError.kCanceled + 1;
  AnnotateImageError.kAdult = AnnotateImageError.kFailure + 1;
  ...
  ImageProcessor_GetJpgImageData_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.bytes = decoder.decodeArrayPointer(codec.Uint8);
  ...
  Annotator_AnnotateImage_Params.decode = function(decoder) {
    ...
    val.descriptionLanguageTag = decoder.decodeStruct(codec.String);
    val.imageProcessor = decoder.decodeStruct(new codec.Interface(ImageProcessorPtr));
    return val;
  };
  ...
  Annotator_AnnotateImage_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.result = decoder.decodeStruct(AnnotateImageResult);
    return val;
  };
  ...
  Object.defineProperty(AnnotateImageResult.prototype, "annotations", {
    ...
    AnnotateImageResult.decode = function(decoder) {
      ...
      switch (tag) {
        case AnnotateImageResult.Tags.errorCode:
          result.errorCode = decoder.decodeStruct(codec.Int32);
          break;
        case AnnotateImageResult.Tags.annotations:
  ...
  var kImageProcessor_GetJpgImageData_Name = 0;
  ...
  var kAnnotator_AnnotateImage_Name = 0;
