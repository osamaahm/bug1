...
(function() {
  ...
  var Determinism = {};
  Determinism.NONE = 0;
  Determinism.FORCE_GC = Determinism.NONE + 1;
  ...
  RequestArgs.decode = function(decoder) {
    ...
    val.determinism = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ProcessMemoryDump.decode = function(decoder) {
    ...
    val.serviceName = decoder.decodeStruct(codec.NullableString);
    return val;
  };
  ...
  AggregatedMetrics.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.nativeLibraryResidentKb = decoder.decodeStruct(codec.Int32);
    val.nativeLibraryResidentNotOrderedKb = decoder.decodeStruct(codec.Int32);
    val.nativeLibraryNotResidentOrderedKb = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  Coordinator_RequestGlobalMemoryDump_Params.decode = function(decoder) {
    ...
    val.dumpType = decoder.decodeStruct(codec.Int32);
    val.levelOfDetail = decoder.decodeStruct(codec.Int32);
    val.determinsm = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  function CoordinatorController_RegisterClientProcess_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CoordinatorController_RegisterClientProcess_Params.prototype.initDefaults_ = function() {
    this.receiver = new bindings.InterfaceRequest();
    this.clientProcess = new ClientProcessPtr();
    this.processType = 0;
    this.processId = null;
  ...
  CoordinatorController_RegisterClientProcess_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CoordinatorController_RegisterClientProcess_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate CoordinatorController_RegisterClientProcess_Params.receiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate CoordinatorController_RegisterClientProcess_Params.clientProcess
    err = messageValidator.validateInterface(offset + codec.kStructHeaderSize + 4, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate CoordinatorController_RegisterClientProcess_Params.processType
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, ProcessType);
    if (err !== validator.validationError.NONE)
        return err;


    // validate CoordinatorController_RegisterClientProcess_Params.processId
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, process_id$.ProcessId, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate CoordinatorController_RegisterClientProcess_Params.serviceName
  ...
  CoordinatorController_RegisterClientProcess_Params.encodedSize = codec.kStructHeaderSize + 32;

  CoordinatorController_RegisterClientProcess_Params.decode = function(decoder) {
    var packed;
    var val = new CoordinatorController_RegisterClientProcess_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.receiver = decoder.decodeStruct(codec.InterfaceRequest);
    val.clientProcess = decoder.decodeStruct(new codec.Interface(ClientProcessPtr));
    val.processType = decoder.decodeStruct(codec.Int32);
    val.processId = decoder.decodeStructPointer(process_id$.ProcessId);
    val.serviceName = decoder.decodeStruct(codec.NullableString);
    return val;
  };

  CoordinatorController_RegisterClientProcess_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CoordinatorController_RegisterClientProcess_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.InterfaceRequest, val.receiver);
    encoder.encodeStruct(new codec.Interface(ClientProcessPtr), val.clientProcess);
    encoder.encodeStruct(codec.Int32, val.processType);
    encoder.encodeStructPointer(process_id$.ProcessId, val.processId);
    encoder.encodeStruct(codec.NullableString, val.serviceName);
  };
  ...
  var kClientProcess_RequestChromeMemoryDump_Name = 0;
  var kClientProcess_RequestOSMemoryDump_Name = 1;
  ...
  var kHeapProfiler_DumpProcessesForTracing_Name = 0;
  ...
  var kHeapProfilerHelper_GetVmRegionsForHeapProfiler_Name = 0;
  ...
  var kCoordinator_RequestGlobalMemoryDump_Name = 0;
  var kCoordinator_RequestGlobalMemoryDumpForPid_Name = 1;
  var kCoordinator_RequestPrivateMemoryFootprint_Name = 2;
  var kCoordinator_RequestGlobalMemoryDumpAndAppendToTrace_Name = 3;
  ...
  var kCoordinatorConnector_RegisterCoordinatorClient_Name = 0;
  ...
  var kCoordinatorController_RegisterClientProcess_Name = 0;

  function CoordinatorControllerPtr(handleOrPtrInfo) {
    this.ptr = new bindings.InterfacePtrController(CoordinatorController,
                                                   handleOrPtrInfo);
  }

  function CoordinatorControllerAssociatedPtr(associatedInterfacePtrInfo) {
    this.ptr = new associatedBindings.AssociatedInterfacePtrController(
        CoordinatorController, associatedInterfacePtrInfo);
  }

  CoordinatorControllerAssociatedPtr.prototype =
      Object.create(CoordinatorControllerPtr.prototype);
  CoordinatorControllerAssociatedPtr.prototype.constructor =
      CoordinatorControllerAssociatedPtr;

  function CoordinatorControllerProxy(receiver) {
    this.receiver_ = receiver;
  }
  CoordinatorControllerPtr.prototype.registerClientProcess = function() {
    return CoordinatorControllerProxy.prototype.registerClientProcess
        .apply(this.ptr.getProxy(), arguments);
  };

  CoordinatorControllerProxy.prototype.registerClientProcess = function(receiver, clientProcess, processType, processId, serviceName) {
    var params_ = new CoordinatorController_RegisterClientProcess_Params();
    params_.receiver = receiver;
    params_.clientProcess = clientProcess;
    ...
    var builder = new codec.MessageV0Builder(
        kCoordinatorController_RegisterClientProcess_Name,
        codec.align(CoordinatorController_RegisterClientProcess_Params.encodedSize));
    builder.encodeStruct(CoordinatorController_RegisterClientProcess_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };

  function CoordinatorControllerStub(delegate) {
    this.delegate_ = delegate;
  }
  CoordinatorControllerStub.prototype.registerClientProcess = function(receiver, clientProcess, processType, processId, serviceName) {
    return this.delegate_ && this.delegate_.registerClientProcess && this.delegate_.registerClientProcess(receiver, clientProcess, processType, processId, serviceName);
  }

  CoordinatorControllerStub.prototype.accept = function(message) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    case kCoordinatorController_RegisterClientProcess_Name:
      var params = reader.decodeStruct(CoordinatorController_RegisterClientProcess_Params);
      this.registerClientProcess(params.receiver, params.clientProcess, params.processType, params.processId, params.serviceName);
      return true;
    default:
      return false;
    }
  ...
  CoordinatorControllerStub.prototype.acceptWithResponder =
      function(message, responder) {
    var reader = new codec.MessageReader(message);
    switch (reader.messageName) {
    default:
  ...
  function validateCoordinatorControllerRequest(messageValidator) {
    var message = messageValidator.message;
    var paramsClass = null;
    switch (message.getName()) {
      case kCoordinatorController_RegisterClientProcess_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = CoordinatorController_RegisterClientProcess_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateCoordinatorControllerResponse(messageValidator) {
    return validator.validationError.NONE;
  }
  ...
  var CoordinatorController = {
    ...
    kVersion: 0,
    ptrClass: CoordinatorControllerPtr,
    proxyClass: CoordinatorControllerProxy,
    stubClass: CoordinatorControllerStub,
    validateRequest: validateCoordinatorControllerRequest,
    validateResponse: null,
  };
  CoordinatorControllerStub.prototype.validator = validateCoordinatorControllerRequest;
  CoordinatorControllerProxy.prototype.validator = null;
  ...
  exports.CoordinatorControllerPtr = CoordinatorControllerPtr;
  exports.CoordinatorControllerAssociatedPtr = CoordinatorControllerAssociatedPtr;
})();