...
(function() {
  ...
  var CreatePushSubscriptionResultCode = {};
  CreatePushSubscriptionResultCode.kCreatedWithRequestedSettings = 0;
  CreatePushSubscriptionResultCode.kCreatedWithDifferentSettings = CreatePushSubscriptionResultCode.kCreatedWithRequestedSettings + 1;
  CreatePushSubscriptionResultCode.kFailed = CreatePushSubscriptionResultCode.kCreatedWithDifferentSettings + 1;
  CreatePushSubscriptionResultCode.MIN_VALUE = 0,
  CreatePushSubscriptionResultCode.MAX_VALUE = 2,

  CreatePushSubscriptionResultCode.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  CreatePushSubscriptionResultCode.validate = function(enumValue) {
  ...
  VideoSource_CreatePushSubscription_Params.prototype.initDefaults_ = function() {
    this.subscriber = new receiver$.ReceiverPtr();
  ...
  VideoSource_CreatePushSubscription_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.subscriber = decoder.decodeStruct(new codec.Interface(receiver$.ReceiverPtr));
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.subscription = decoder.decodeStruct(codec.InterfaceRequest);
    return val;
  };
  ...
  VideoSource_CreatePushSubscription_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStruct(new codec.Interface(receiver$.ReceiverPtr), val.subscriber);
  ...
  VideoSource_CreatePushSubscription_ResponseParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, CreatePushSubscriptionResultCode);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  VideoSource_CreatePushSubscription_ResponseParams.encodedSize = codec.kStructHeaderSize + 16;
  ...
  VideoSource_CreatePushSubscription_ResponseParams.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.settingsSourceWasOpenedWith = decoder.decodeStructPointer(video_capture_types$.VideoCaptureParams);
    return val;
  };
  ...
  var kPushVideoStreamSubscription_Activate_Name = 0;
  var kPushVideoStreamSubscription_Suspend_Name = 1;
  var kPushVideoStreamSubscription_Resume_Name = 2;
  var kPushVideoStreamSubscription_GetPhotoState_Name = 3;
  var kPushVideoStreamSubscription_SetPhotoOptions_Name = 4;
  var kPushVideoStreamSubscription_TakePhoto_Name = 5;
  var kPushVideoStreamSubscription_Close_Name = 6;
  ...
  var kVideoSource_CreatePushSubscription_Name = 0;
