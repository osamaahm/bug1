...
(function() {
  ...
  PortInfo.decode = function(decoder) {
    ...
    val.manufacturer = decoder.decodeStruct(codec.String);
  ...
  MidiSessionClient_AddInputPort_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.info = decoder.decodeStructPointer(PortInfo);
    return val;
  };
  ...
  MidiSessionClient_SetInputPortState_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.port = decoder.decodeStruct(codec.Uint32);
    val.state = decoder.decodeStruct(codec.Int32);
    return val;
  };
  ...
  MidiSessionProvider_StartSession_Params.decode = function(decoder) {
    ...
    val.client = decoder.decodeStruct(new codec.Interface(MidiSessionClientPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kMidiSessionClient_AddInputPort_Name = 0;
  var kMidiSessionClient_AddOutputPort_Name = 1;
  var kMidiSessionClient_SetInputPortState_Name = 2;
  var kMidiSessionClient_SetOutputPortState_Name = 3;
  var kMidiSessionClient_SessionStarted_Name = 4;
  var kMidiSessionClient_AcknowledgeSentData_Name = 5;
  var kMidiSessionClient_DataReceived_Name = 6;
  ...
  var kMidiSessionProvider_StartSession_Name = 0;
  ...
  var kMidiSession_SendData_Name = 0;
