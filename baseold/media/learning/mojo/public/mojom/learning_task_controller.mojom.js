...
(function() {
  ...
  LearningTaskController_BeginObservation_Params.decode = function(decoder) {
    ...
    val.features = decoder.decodeArrayPointer(new codec.PointerTo(learning_types$.FeatureValue));
    val.defaultTarget = decoder.decodeStructPointer(learning_types$.TargetValue);
    return val;
  };
  ...
  LearningTaskController_CompleteObservation_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.id = decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
    val.completion = decoder.decodeStructPointer(learning_types$.ObservationCompletion);
    return val;
  };
  ...
  var kLearningTaskController_BeginObservation_Name = 0;
  var kLearningTaskController_CompleteObservation_Name = 1;
  var kLearningTaskController_CancelObservation_Name = 2;
  ...
  LearningTaskControllerProxy.prototype.validator = null;
