...
(function() {
  ...
  SupportedVideoDecoderConfig.decode = function(decoder) {
    ...
    val.profileMin = decoder.decodeStruct(codec.Int32);
    val.profileMax = decoder.decodeStruct(codec.Int32);
    val.codedSizeMin = decoder.decodeStructPointer(geometry$.Size);
    val.codedSizeMax = decoder.decodeStructPointer(geometry$.Size);
  ...
  VideoDecoder_GetSupportedConfigs_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.supportedConfigs = decoder.decodeMapPointer(new codec.Enum(VideoDecoderImplementation), new codec.ArrayOf(new codec.PointerTo(SupportedVideoDecoderConfig)));
    return val;
  };
  ...
  VideoDecoder_Construct_Params.decode = function(decoder) {
    ...
    val.implementation = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
