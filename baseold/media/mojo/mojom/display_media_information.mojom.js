...
(function() {
  ...
  DisplayCaptureSurfaceType.WINDOW = DisplayCaptureSurfaceType.MONITOR + 1;
  DisplayCaptureSurfaceType.APPLICATION = DisplayCaptureSurfaceType.WINDOW + 1;
  DisplayCaptureSurfaceType.BROWSER = DisplayCaptureSurfaceType.APPLICATION + 1;
  ...
  CursorCaptureType.ALWAYS = CursorCaptureType.NEVER + 1;
  CursorCaptureType.MOTION = CursorCaptureType.ALWAYS + 1;
  ...
  DisplayMediaInformation.decode = function(decoder) {
    ...
    val.displaySurface = decoder.decodeStruct(codec.Int32);
    packed = decoder.readUint8();
    val.logicalSurface = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.cursor = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
