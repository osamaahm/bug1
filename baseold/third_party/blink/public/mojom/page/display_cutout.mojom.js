...
(function() {
  ...
  var ViewportFit = {};
  ViewportFit.kAuto = 0;
  ViewportFit.kContain = ViewportFit.kAuto + 1;
  ViewportFit.kCover = ViewportFit.kContain + 1;
  ViewportFit.kCoverForcedByUserAgent = ViewportFit.kCover + 1;
  ...
  DisplayCutoutClient_SetSafeArea_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.safeArea = decoder.decodeStructPointer(DisplayCutoutSafeArea);
    return val;
  };
