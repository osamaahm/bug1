...
(function() {
  ...
  AuthenticatorStatus.INVALID_ICON_URL = AuthenticatorStatus.INVALID_DOMAIN + 1;
  AuthenticatorStatus.CREDENTIAL_EXCLUDED = AuthenticatorStatus.INVALID_ICON_URL + 1;
  ...
  AuthenticatorStatus.MAX_VALUE = 16,
  ...
  UserVerificationRequirement.PREFERRED = UserVerificationRequirement.REQUIRED + 1;
  UserVerificationRequirement.DISCOURAGED = UserVerificationRequirement.PREFERRED + 1;
  ...
  PublicKeyCredentialCreationOptions.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.appidExclude = decoder.decodeStruct(codec.NullableString);
    return val;
  };
