...
(function() {
  ...
  DedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Params.validate = function(messageValidator, offset) {
    ...
    // validate DedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Params.interfaceProvider
  ...
  DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params.validate = function(messageValidator, offset) {
    ...
    // validate DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params.serviceWorkerProviderInfo
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, service_worker_provider$.ServiceWorkerProviderInfoForClient, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  DedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Params.decode = function(decoder) {
    ...
    val.subresourceLoaderUpdater = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  DedicatedWorkerHostFactory_CreateWorkerHost_Params.validate = function(messageValidator, offset) {
    ...
    // validate DedicatedWorkerHostFactory_CreateWorkerHost_Params.origin
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, origin$.Origin, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate DedicatedWorkerHostFactory_CreateWorkerHost_Params.workerInterfaceProvider
  ...
  DedicatedWorkerHostFactory_CreateWorkerHost_Params.decode = function(decoder) {
    ...
    val.browserInterfaceBroker = decoder.decodeStruct(codec.InterfaceRequest);
  ...
  DedicatedWorkerHostFactory_CreateWorkerHostAndStartScriptLoad_Params.validate = function(messageValidator, offset) {
    ...
    // validate DedicatedWorkerHostFactory_CreateWorkerHostAndStartScriptLoad_Params.origin
    ...
    // validate DedicatedWorkerHostFactory_CreateWorkerHostAndStartScriptLoad_Params.host
  ...
  DedicatedWorkerHostFactory_CreateWorkerHostAndStartScriptLoad_Params.decode = function(decoder) {
    ...
    val.host = decoder.decodeStruct(codec.InterfaceRequest);
    val.outsideFetchClientSettingsObject = decoder.decodeStructPointer(fetch_client_settings_object$.FetchClientSettingsObject);
    val.blobUrlToken = decoder.decodeStruct(new codec.NullableInterface(blob_url_store$.BlobURLTokenPtr));
    val.client = decoder.decodeStruct(new codec.Interface(DedicatedWorkerHostFactoryClientPtr));
    return val;
  };
  ...
  var kDedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Name = 0;
  var kDedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Name = 1;
  var kDedicatedWorkerHostFactoryClient_OnScriptLoadStartFailed_Name = 2;
  ...
  DedicatedWorkerHostFactoryClientProxy.prototype.onWorkerHostCreated = function(interfaceProvider, browserInterfaceBroker) {
  ...
  DedicatedWorkerHostFactoryClientProxy.prototype.onScriptLoadStarted = function(serviceWorkerProviderInfo, mainScriptLoadParams, subresourceLoaderFactories, subresourceLoaderUpdater, controllerInfo) {
  ...
  DedicatedWorkerHostFactoryClientStub.prototype.onWorkerHostCreated = function(interfaceProvider, browserInterfaceBroker) {
    return this.delegate_ && this.delegate_.onWorkerHostCreated && this.delegate_.onWorkerHostCreated(interfaceProvider, browserInterfaceBroker);
  }
  DedicatedWorkerHostFactoryClientStub.prototype.onScriptLoadStarted = function(serviceWorkerProviderInfo, mainScriptLoadParams, subresourceLoaderFactories, subresourceLoaderUpdater, controllerInfo) {
    return this.delegate_ && this.delegate_.onScriptLoadStarted && this.delegate_.onScriptLoadStarted(serviceWorkerProviderInfo, mainScriptLoadParams, subresourceLoaderFactories, subresourceLoaderUpdater, controllerInfo);
  }
  ...
  DedicatedWorkerHostFactoryClientStub.prototype.accept = function(message) {
    ...
    case kDedicatedWorkerHostFactoryClient_OnWorkerHostCreated_Name:
      ...
      this.onWorkerHostCreated(params.interfaceProvider, params.browserInterfaceBroker);
      return true;
    case kDedicatedWorkerHostFactoryClient_OnScriptLoadStarted_Name:
      ...
      this.onScriptLoadStarted(params.serviceWorkerProviderInfo, params.mainScriptLoadParams, params.subresourceLoaderFactories, params.subresourceLoaderUpdater, params.controllerInfo);
      return true;
  ...
  var kDedicatedWorkerHostFactory_CreateWorkerHost_Name = 0;
  var kDedicatedWorkerHostFactory_CreateWorkerHostAndStartScriptLoad_Name = 1;
  ...
  DedicatedWorkerHostFactoryProxy.prototype.createWorkerHost = function(origin, workerInterfaceProvider, browserInterfaceBroker, host) {
  ...
  DedicatedWorkerHostFactoryProxy.prototype.createWorkerHostAndStartScriptLoad = function(scriptUrl, origin, credentialsMode, outsideFetchClientSettingsObject, blobUrlToken, client, host) {
  ...
  DedicatedWorkerHostFactoryStub.prototype.createWorkerHost = function(origin, workerInterfaceProvider, browserInterfaceBroker, host) {
    return this.delegate_ && this.delegate_.createWorkerHost && this.delegate_.createWorkerHost(origin, workerInterfaceProvider, browserInterfaceBroker, host);
  }
  DedicatedWorkerHostFactoryStub.prototype.createWorkerHostAndStartScriptLoad = function(scriptUrl, origin, credentialsMode, outsideFetchClientSettingsObject, blobUrlToken, client, host) {
    return this.delegate_ && this.delegate_.createWorkerHostAndStartScriptLoad && this.delegate_.createWorkerHostAndStartScriptLoad(scriptUrl, origin, credentialsMode, outsideFetchClientSettingsObject, blobUrlToken, client, host);
  }
  ...
  DedicatedWorkerHostFactoryStub.prototype.accept = function(message) {
    ...
    case kDedicatedWorkerHostFactory_CreateWorkerHost_Name:
      ...
      this.createWorkerHost(params.origin, params.workerInterfaceProvider, params.browserInterfaceBroker, params.host);
      return true;
    case kDedicatedWorkerHostFactory_CreateWorkerHostAndStartScriptLoad_Name:
      ...
      this.createWorkerHostAndStartScriptLoad(params.scriptUrl, params.origin, params.credentialsMode, params.outsideFetchClientSettingsObject, params.blobUrlToken, params.client, params.host);
      return true;
    default:
      return false;
    }
  ...
  DedicatedWorkerHostFactoryProxy.prototype.validator = null;
