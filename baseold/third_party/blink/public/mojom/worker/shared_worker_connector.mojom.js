...
(function() {
  ...
  SharedWorkerConnector_Connect_Params.validate = function(messageValidator, offset) {
    ...
    // validate SharedWorkerConnector_Connect_Params.outsideFetchClientSettingsObject
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, fetch_client_settings_object$.FetchClientSettingsObject, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 24, shared_worker_creation_context_type$.SharedWorkerCreationContextType);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SharedWorkerConnector_Connect_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  SharedWorkerConnectorProxy.prototype.connect = function(info, outsideFetchClientSettingsObject, client, creationContextType, messagePort, blobUrlToken) {
  ...
  SharedWorkerConnectorStub.prototype.connect = function(info, outsideFetchClientSettingsObject, client, creationContextType, messagePort, blobUrlToken) {
    return this.delegate_ && this.delegate_.connect && this.delegate_.connect(info, outsideFetchClientSettingsObject, client, creationContextType, messagePort, blobUrlToken);
  }
  ...
  SharedWorkerConnectorStub.prototype.accept = function(message) {
    ...
    case kSharedWorkerConnector_Connect_Name:
      ...
      this.connect(params.info, params.outsideFetchClientSettingsObject, params.client, params.creationContextType, params.messagePort, params.blobUrlToken);
      return true;
    default:
      return false;
    }
