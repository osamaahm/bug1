...
(function() {
  ...
  WorkerMainScriptLoadParams.decode = function(decoder) {
    ...
    val.responseHead = decoder.decodeStructPointer(url_response_head$.URLResponseHead);
    val.responseBody = decoder.decodeStruct(codec.NullableHandle);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.urlLoaderClientEndpoints = decoder.decodeStructPointer(url_loader$.URLLoaderClientEndpoints);
    val.redirectInfos = decoder.decodeArrayPointer(new codec.PointerTo(url_loader$.URLRequestRedirectInfo));
    val.redirectResponseHeads = decoder.decodeArrayPointer(new codec.PointerTo(url_response_head$.URLResponseHead));
    return val;
  };
