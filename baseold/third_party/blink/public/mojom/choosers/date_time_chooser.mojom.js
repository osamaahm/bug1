...
(function() {
  ...
  DateTimeSuggestion.decode = function(decoder) {
    ...
    val.localizedValue = decoder.decodeStructPointer(string16$.String16);
  ...
  DateTimeDialogValue.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.dialogType = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.dialogValue = decoder.decodeStruct(codec.Double);
    val.minimum = decoder.decodeStruct(codec.Double);
    val.maximum = decoder.decodeStruct(codec.Double);
    val.step = decoder.decodeStruct(codec.Double);
    val.suggestions = decoder.decodeArrayPointer(new codec.PointerTo(DateTimeSuggestion));
    return val;
  };
  ...
  DateTimeChooser_OpenDateTimeDialog_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.value = decoder.decodeStructPointer(DateTimeDialogValue);
    return val;
  };
