...
(function() {
  ...
  FileChooserParams.Mode.kOpenMultiple = FileChooserParams.Mode.kOpen + 1;
  FileChooserParams.Mode.kUploadFolder = FileChooserParams.Mode.kOpenMultiple + 1;
  FileChooserParams.Mode.kSave = FileChooserParams.Mode.kUploadFolder + 1;
  ...
  FileChooserParams.decode = function(decoder) {
    ...
    val.defaultFileName = decoder.decodeStructPointer(file_path$.FilePath);
    val.selectedFiles = decoder.decodeArrayPointer(new codec.PointerTo(file_path$.FilePath));
    val.acceptTypes = decoder.decodeArrayPointer(new codec.PointerTo(string16$.String16));
    val.requestor = decoder.decodeStructPointer(url$.Url);
    return val;
  };
  ...
  FileChooserResult.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.files = decoder.decodeArrayPointer(FileChooserFileInfo);
    val.baseDirectory = decoder.decodeStructPointer(file_path$.FilePath);
    return val;
  };
  ...
  FileChooser_OpenFileChooser_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.params = decoder.decodeStructPointer(FileChooserParams);
    return val;
  };
  ...
  FileChooser_OpenFileChooser_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.result = decoder.decodeStructPointer(FileChooserResult);
    return val;
  };
  ...
  FileChooser_EnumerateChosenDirectory_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.directoryPath = decoder.decodeStructPointer(file_path$.FilePath);
    return val;
  };
