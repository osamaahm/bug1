...
(function() {
  ...
  AnchorElementMetrics.decode = function(decoder) {
    ...
    val.ratioArea = decoder.decodeStruct(codec.Float);
    val.ratioVisibleArea = decoder.decodeStruct(codec.Float);
    val.ratioDistanceTopToVisibleTop = decoder.decodeStruct(codec.Float);
    val.ratioDistanceCenterToVisibleTop = decoder.decodeStruct(codec.Float);
    val.ratioDistanceRootTop = decoder.decodeStruct(codec.Float);
    val.ratioDistanceRootBottom = decoder.decodeStruct(codec.Float);
  ...
  AnchorElementMetricsHost_ReportAnchorElementMetricsOnClick_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.metrics = decoder.decodeStructPointer(AnchorElementMetrics);
    return val;
  };
  ...
  AnchorElementMetricsHost_ReportAnchorElementMetricsOnLoad_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.metrics = decoder.decodeArrayPointer(new codec.PointerTo(AnchorElementMetrics));
    val.viewportSize = decoder.decodeStructPointer(geometry$.Size);
    return val;
  };
