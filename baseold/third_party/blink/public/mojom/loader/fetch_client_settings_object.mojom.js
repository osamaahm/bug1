...
(function() {
  ...
  InsecureRequestsPolicy.kUpgrade = InsecureRequestsPolicy.kDoNotUpgrade + 1;
  ...
  FetchClientSettingsObject.decode = function(decoder) {
    ...
    val.insecureRequestsPolicy = decoder.decodeStruct(codec.Int32);
    val.outgoingReferrer = decoder.decodeStructPointer(url$.Url);
    return val;
  };
