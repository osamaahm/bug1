...
(function() {
  ...
  Manifest.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, url$.Url, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ManifestShareTarget.Enctype.kMultipartFormData = ManifestShareTarget.Enctype.kFormUrlEncoded + 1;
