...
(function() {
  ...
  UsageBreakdown.encodedSize = codec.kStructHeaderSize + 56;
  ...
  UsageBreakdown.decode = function(decoder) {
    ...
    val.fileSystem = decoder.decodeStruct(codec.Int64);
    val.webSql = decoder.decodeStruct(codec.Int64);
    val.appcache = decoder.decodeStruct(codec.Int64);
    val.indexedDatabase = decoder.decodeStruct(codec.Int64);
    val.serviceWorkerCache = decoder.decodeStruct(codec.Int64);
    val.serviceWorker = decoder.decodeStruct(codec.Int64);
    val.backgroundFetch = decoder.decodeStruct(codec.Int64);
    return val;
  };
