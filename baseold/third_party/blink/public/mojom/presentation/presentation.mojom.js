...
(function() {
  ...
  PresentationConnectionResult.decode = function(decoder) {
    ...
    val.connectionRemote = decoder.decodeStruct(new codec.Interface(PresentationConnectionPtr));
  ...
  PresentationReceiver_OnReceiverConnectionAvailable_Params.decode = function(decoder) {
    ...
    val.receiverConnectionReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
