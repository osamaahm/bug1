...
(function() {
  ...
  SpeechSynthesisUtterance.decode = function(decoder) {
    ...
    val.lang = decoder.decodeStruct(codec.String);
    val.voice = decoder.decodeStruct(codec.String);
    val.volume = decoder.decodeStruct(codec.Double);
    val.rate = decoder.decodeStruct(codec.Double);
    val.pitch = decoder.decodeStruct(codec.Double);
    return val;
  };
  ...
  SpeechSynthesisVoice.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.voiceUri = decoder.decodeStruct(codec.String);
  ...
  SpeechSynthesisVoiceListObserver_OnSetVoiceList_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.voiceList = decoder.decodeArrayPointer(new codec.PointerTo(SpeechSynthesisVoice));
    return val;
  };
  ...
  SpeechSynthesisClient_OnEncounteredWordBoundary_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.charIndex = decoder.decodeStruct(codec.Uint32);
    val.charLength = decoder.decodeStruct(codec.Uint32);
    return val;
  };
  ...
  SpeechSynthesis_AddVoiceListObserver_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.observer = decoder.decodeStruct(new codec.Interface(SpeechSynthesisVoiceListObserverPtr));
    return val;
  };
  ...
  SpeechSynthesis_Speak_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.utterance = decoder.decodeStructPointer(SpeechSynthesisUtterance);
    val.client = decoder.decodeStruct(new codec.Interface(SpeechSynthesisClientPtr));
    return val;
  };
