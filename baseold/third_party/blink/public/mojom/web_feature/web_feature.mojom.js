...
(function() {
  ...
  WebFeature.kDeviceMotionInsecureOrigin_Obsolete = 668;
  WebFeature.kDeviceMotionSecureOrigin = 669;
  WebFeature.kDeviceOrientationInsecureOrigin_Obsolete = 670;
  ...
  WebFeature.kDeviceOrientationAbsoluteInsecureOrigin_Obsolete = 987;
  ...
  WebFeature.kDOMNodeRemovedEventDelayed = 2501;
  WebFeature.kDOMNodeRemovedEventHandlerAccessDetachingNode = 2502;
  WebFeature.kDOMNodeRemovedEventListenedAtNonTarget = 2503;
  WebFeature.kDOMNodeRemovedFromDocumentEventDelayed = 2504;
  WebFeature.kDOMNodeRemovedFromDocumentEventHandlerAccessDetachingNode = 2505;
  WebFeature.kDOMNodeRemovedFromDocumentEventListenedAtNonTarget = 2506;
  ...
  WebFeature.kShapeDetectionAPI = 2522;
  ...
  WebFeature.kEvaluateScriptMovedBetweenDocuments = 2528;
  ...
  WebFeature.kV8AtomicsNotify = 2555;
  WebFeature.kV8AtomicsWake = 2556;
  ...
  WebFeature.kCSSValueAppearanceCheckboxForOthersRendered = 2560;
  WebFeature.kCSSValueAppearanceRadioRendered = 2561;
  WebFeature.kCSSValueAppearanceRadioForOthersRendered = 2562;
  WebFeature.kCSSValueAppearanceInnerSpinButtonRendered = 2563;
  WebFeature.kCSSValueAppearanceInnerSpinButtonForOthersRendered = 2564;
  WebFeature.kCSSValueAppearanceMenuListRendered = 2565;
  WebFeature.kCSSValueAppearanceMenuListForOthersRendered = 2566;
  WebFeature.kCSSValueAppearanceProgressBarRendered = 2567;
  WebFeature.kCSSValueAppearanceSliderHorizontalRendered = 2568;
  WebFeature.kCSSValueAppearanceSliderHorizontalForOthersRendered = 2569;
  WebFeature.kCSSValueAppearanceSliderVerticalRendered = 2570;
  WebFeature.kCSSValueAppearanceSliderVerticalForOthersRendered = 2571;
  WebFeature.kCSSValueAppearanceSliderThumbHorizontalRendered = 2572;
  WebFeature.kCSSValueAppearanceSliderThumbHorizontalForOthersRendered = 2573;
  WebFeature.kCSSValueAppearanceSliderThumbVerticalRendered = 2574;
  WebFeature.kCSSValueAppearanceSliderThumbVerticalForOthersRendered = 2575;
  WebFeature.kCSSValueAppearanceSearchFieldRendered = 2576;
  WebFeature.kCSSValueAppearanceSearchFieldForOthersRendered = 2577;
  WebFeature.kCSSValueAppearanceSearchCancelRendered = 2578;
  WebFeature.kCSSValueAppearanceSearchCancelForOthersRendered = 2579;
  WebFeature.kCSSValueAppearanceTextAreaRendered = 2580;
  WebFeature.kCSSValueAppearanceTextAreaForOthersRendered = 2581;
  WebFeature.kCSSValueAppearanceMenuListButtonRendered = 2582;
  WebFeature.kCSSValueAppearanceMenuListButtonForOthersRendered = 2583;
  WebFeature.kCSSValueAppearancePushButtonRendered = 2584;
  WebFeature.kCSSValueAppearancePushButtonForOthersRendered = 2585;
  WebFeature.kCSSValueAppearanceSquareButtonRendered = 2586;
  WebFeature.kCSSValueAppearanceSquareButtonForOthersRendered = 2587;
  ...
  WebFeature.kTrustedTypesDefaultPolicyUsed = 2724;
  ...
  WebFeature.kForbiddenSyncXhrInPageDismissal = 2732;
  ...
  WebFeature.kPerMethodCanMakePaymentQuota = 2773;
  WebFeature.kCSSValueAppearanceButtonForNonButtonRendered = 2774;
  WebFeature.kCSSValueAppearanceButtonForOthersRendered = 2775;
  ...
  WebFeature.kCSSValueAppearanceProgressBarForOthersRendered = 2817;
  ...
  WebFeature.kCSSValueAppearanceTextFieldForOthersRendered = 2822;
  WebFeature.kCSSValueAppearanceTextFieldForTemporalRendered = 2823;
  WebFeature.kBuiltInModuleKvStorage = 2824;
  WebFeature.kBuiltInModuleVirtualScroller = 2825;
  ...
  WebFeature.kDownloadInSandboxWithoutUserGesture = 2840;
  ...
  WebFeature.kHTMLImportsOnReverseOriginTrials = 2847;
  WebFeature.kElementCreateShadowRootOnReverseOriginTrials = 2848;
  WebFeature.kDocumentRegisterElementOnReverseOriginTrials = 2849;
  ...
  WebFeature.kSMSReceiverStart = 2880;
  ...
  WebFeature.kRevertInCustomIdent = 2889;
  ...
  WebFeature.kCSSValueAppearanceSearchCancelForOthers2Rendered = 2905;
  ...
  WebFeature.kBuiltInModuleSwitchImported = 2921;
  ...
  WebFeature.kBuiltInModuleToast = 2926;
  ...
  WebFeature.kCSSValueAppearanceButtonForBootstrapLooseSelectorRendered = 2963;
  WebFeature.kCSSValueAppearanceButtonForOthers2Rendered = 2964;
  WebFeature.kCSSValueAppearanceButtonForSelectRendered = 2965;
  WebFeature.kCSSValueAppearanceListboxForOthersRendered = 2966;
  WebFeature.kCSSValueAppearanceMeterForOthersRendered = 2967;
  WebFeature.kSVGSMILDiscardElementParsed = 2968;
  WebFeature.kSVGSMILDiscardElementTriggered = 2969;
  WebFeature.kV8PointerEvent_GetPredictedEvents_Method = 2971;
  WebFeature.kScrollSnapOnViewportBreaks = 2972;
  WebFeature.kScrollPaddingOnViewportBreaks = 2973;
  ...
  WebFeature.kMediaCapabilitiesFramerateRatio = 3010;
  WebFeature.kMediaCapabilitiesFramerateNumber = 3011;
  ...
  WebFeature.kDelegateFocusNotFirstInFlatTree = 3031;
  ...
  WebFeature.kEvaluateScriptMovedBetweenElementDocuments = 3045;
  ...
  WebFeature.kARIAAnnotationRoles = 3050;
  ...
  WebFeature.kNumberOfFeatures = WebFeature.kDecompressionStreamConstructor + 1;
  WebFeature.MIN_VALUE = 0,
  WebFeature.MAX_VALUE = 3062,
