...
(function() {
  ...
  Portal_Activate_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  Portal_Activate_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.data = decoder.decodeStructPointer(transferable_message$.TransferableMessage);
    return val;
  };
  ...
  Portal_Activate_ResponseParams.decode = function(decoder) {
    ...
    val.wasAdopted = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  Portal_PostMessageToGuest_Params.validate = function(messageValidator, offset) {
    ...
    // validate Portal_PostMessageToGuest_Params.targetOrigin
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, origin1$.Origin, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  Portal_PostMessageToGuest_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  Portal_PostMessageToGuest_Params.decode = function(decoder) {
    ...
    val.targetOrigin = decoder.decodeStructPointer(origin1$.Origin);
    return val;
  };
  ...
  Portal_PostMessageToGuest_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(origin1$.Origin, val.targetOrigin);
  };
  ...
  PortalClient_ForwardMessageFromGuest_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, origin1$.Origin, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate PortalClient_ForwardMessageFromGuest_Params.targetOrigin
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, origin1$.Origin, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PortalClient_ForwardMessageFromGuest_Params.encodedSize = codec.kStructHeaderSize + 24;
  ...
  PortalClient_ForwardMessageFromGuest_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.message = decoder.decodeStructPointer(transferable_message$.TransferableMessage);
    val.sourceOrigin = decoder.decodeStructPointer(origin1$.Origin);
    val.targetOrigin = decoder.decodeStructPointer(origin1$.Origin);
    return val;
  };
  ...
  PortalClient_ForwardMessageFromGuest_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(transferable_message$.TransferableMessage, val.message);
    encoder.encodeStructPointer(origin1$.Origin, val.sourceOrigin);
    encoder.encodeStructPointer(origin1$.Origin, val.targetOrigin);
  };
  ...
  PortalHost_PostMessageToHost_Params.validate = function(messageValidator, offset) {
    ...
    // validate PortalHost_PostMessageToHost_Params.targetOrigin
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, origin1$.Origin, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PortalHost_PostMessageToHost_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kPortal_Navigate_Name = 0;
  var kPortal_Activate_Name = 1;
  var kPortal_PostMessageToGuest_Name = 2;
  ...
  PortalProxy.prototype.activate = function(data) {
  ...
  PortalProxy.prototype.postMessageToGuest = function(message, targetOrigin) {
  ...
  PortalStub.prototype.activate = function(data) {
    return this.delegate_ && this.delegate_.activate && this.delegate_.activate(data);
  }
  PortalStub.prototype.postMessageToGuest = function(message, targetOrigin) {
    return this.delegate_ && this.delegate_.postMessageToGuest && this.delegate_.postMessageToGuest(message, targetOrigin);
  }
  ...
  PortalStub.prototype.accept = function(message) {
    ...
    case kPortal_PostMessageToGuest_Name:
      ...
      this.postMessageToGuest(params.message, params.targetOrigin);
      return true;
    default:
      return false;
    }
  ...
  PortalStub.prototype.acceptWithResponder =
    ...
    case kPortal_Activate_Name:
      ...
      this.activate(params.data).then(function(response) {
        var responseParams =
            new Portal_Activate_ResponseParams();
        responseParams.wasAdopted = response.wasAdopted;
        var builder = new codec.MessageV1Builder(
            kPortal_Activate_Name,
  ...
  var kPortalClient_ForwardMessageFromGuest_Name = 0;
  var kPortalClient_DispatchLoadEvent_Name = 1;
  ...
  PortalClientProxy.prototype.forwardMessageFromGuest = function(message, sourceOrigin, targetOrigin) {
  ...
  PortalClientStub.prototype.forwardMessageFromGuest = function(message, sourceOrigin, targetOrigin) {
    return this.delegate_ && this.delegate_.forwardMessageFromGuest && this.delegate_.forwardMessageFromGuest(message, sourceOrigin, targetOrigin);
  }
  ...
  PortalClientStub.prototype.accept = function(message) {
    ...
    case kPortalClient_ForwardMessageFromGuest_Name:
      ...
      this.forwardMessageFromGuest(params.message, params.sourceOrigin, params.targetOrigin);
      return true;
  ...
  var kPortalHost_PostMessageToHost_Name = 0;
  ...
  PortalHostProxy.prototype.postMessageToHost = function(message, targetOrigin) {
  ...
  PortalHostStub.prototype.postMessageToHost = function(message, targetOrigin) {
    return this.delegate_ && this.delegate_.postMessageToHost && this.delegate_.postMessageToHost(message, targetOrigin);
  }
  ...
  PortalHostStub.prototype.accept = function(message) {
    ...
    case kPortalHost_PostMessageToHost_Name:
      ...
      this.postMessageToHost(params.message, params.targetOrigin);
      return true;
    default:
      return false;
    }
