// third_party/blink/public/mojom/usb/web_usb_service.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/device/public/mojom/usb_device.mojom', '../../../../../services/device/public/mojom/usb_device.mojom.js');
  }
  var usb_enumeration_options$ =
      mojo.internal.exposeNamespace('device.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/device/public/mojom/usb_enumeration_options.mojom', '../../../../../services/device/public/mojom/usb_enumeration_options.mojom.js');
  }
  var usb_manager_client$ =
      mojo.internal.exposeNamespace('device.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'services/device/public/mojom/usb_manager_client.mojom', '../../../../../services/device/public/mojom/usb_manager_client.mojom.js');
  }
  ...
  WebUsbService_GetDevice_Params.validate = function(messageValidator, offset) {
    ...
    // validate WebUsbService_GetDevice_Params.deviceReceiver
  ...
  WebUsbService_GetDevice_Params.decode = function(decoder) {
    ...
    val.deviceReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  WebUsbService_GetPermission_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(usb_enumeration_options$.UsbDeviceFilter), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebUsbService_GetPermission_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.deviceFilters = decoder.decodeArrayPointer(new codec.PointerTo(usb_enumeration_options$.UsbDeviceFilter));
    return val;
  };
  ...
  WebUsbService_GetPermission_Params.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(usb_enumeration_options$.UsbDeviceFilter), val.deviceFilters);
  };
  ...
  WebUsbService_GetPermission_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.result = decoder.decodeStructPointer(usb_device$.UsbDeviceInfo);
    return val;
  };
  ...
  WebUsbService_GetPermission_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(usb_device$.UsbDeviceInfo, val.result);
  };
  ...
  WebUsbServiceProxy.prototype.getDevice = function(guid, deviceReceiver) {
  ...
  WebUsbServiceStub.prototype.getDevice = function(guid, deviceReceiver) {
    return this.delegate_ && this.delegate_.getDevice && this.delegate_.getDevice(guid, deviceReceiver);
  }
  ...
  WebUsbServiceStub.prototype.accept = function(message) {
    ...
    case kWebUsbService_GetDevice_Name:
      ...
      this.getDevice(params.guid, params.deviceReceiver);
      return true;
