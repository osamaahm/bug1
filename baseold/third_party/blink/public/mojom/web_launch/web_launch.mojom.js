...
(function() {
  ...
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'third_party/blink/public/mojom/native_file_system/native_file_system_directory_handle.mojom', '../native_file_system/native_file_system_directory_handle.mojom.js');
  }
  var url$ =
  ...
  WebLaunchService_SetLaunchFiles_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(native_file_system_directory_handle$.NativeFileSystemEntry), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  WebLaunchService_SetLaunchFiles_Params.decode = function(decoder) {
    ...
    val.files = decoder.decodeArrayPointer(new codec.PointerTo(native_file_system_directory_handle$.NativeFileSystemEntry));
    return val;
  };
  ...
  WebLaunchService_SetLaunchFiles_Params.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(native_file_system_directory_handle$.NativeFileSystemEntry), val.files);
  };
