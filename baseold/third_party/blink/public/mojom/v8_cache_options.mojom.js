...
(function() {
  ...
  V8CacheOptions.kNone = V8CacheOptions.kDefault + 1;
  V8CacheOptions.kCode = V8CacheOptions.kNone + 1;
  V8CacheOptions.kCodeWithoutHeatCheck = V8CacheOptions.kCode + 1;
  V8CacheOptions.kFullCodeWithoutHeatCheck = V8CacheOptions.kCodeWithoutHeatCheck + 1;
