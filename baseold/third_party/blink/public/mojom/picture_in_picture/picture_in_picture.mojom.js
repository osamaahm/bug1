...
(function() {
  ...
  PictureInPictureService_StartSession_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.session = decoder.decodeStruct(new codec.NullableInterface(PictureInPictureSessionPtr));
    val.size = decoder.decodeStructPointer(geometry$.Size);
    return val;
  };
  ...
  PictureInPictureServiceProxy.prototype.startSession = function(playerId, surfaceId, naturalSize, showPlayPauseButton, observer) {
  ...
  PictureInPictureServiceStub.prototype.startSession = function(playerId, surfaceId, naturalSize, showPlayPauseButton, observer) {
    return this.delegate_ && this.delegate_.startSession && this.delegate_.startSession(playerId, surfaceId, naturalSize, showPlayPauseButton, observer);
  }
  ...
  PictureInPictureServiceStub.prototype.acceptWithResponder =
    ...
    case kPictureInPictureService_StartSession_Name:
      ...
      this.startSession(params.playerId, params.surfaceId, params.naturalSize, params.showPlayPauseButton, params.observer).then(function(response) {
        var responseParams =
