...
(function() {
  ...
  PermissionName.BACKGROUND_FETCH = PermissionName.PAYMENT_HANDLER + 1;
  PermissionName.IDLE_DETECTION = PermissionName.BACKGROUND_FETCH + 1;
  PermissionName.PERIODIC_BACKGROUND_SYNC = PermissionName.IDLE_DETECTION + 1;
  PermissionName.WAKE_LOCK = PermissionName.PERIODIC_BACKGROUND_SYNC + 1;
  PermissionName.MIN_VALUE = 0,
  PermissionName.MAX_VALUE = 16,
  ...
  var WakeLockType = {};
  WakeLockType.kScreen = 0;
  WakeLockType.kSystem = WakeLockType.kScreen + 1;
  WakeLockType.MIN_VALUE = 0,
  WakeLockType.MAX_VALUE = 1,
  ...
  function WakeLockPermissionDescriptor(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  WakeLockPermissionDescriptor.prototype.initDefaults_ = function() {
    this.type = 0;
  };
  WakeLockPermissionDescriptor.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  WakeLockPermissionDescriptor.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate WakeLockPermissionDescriptor.type
  ...
  WakeLockPermissionDescriptor.encodedSize = codec.kStructHeaderSize + 8;

  WakeLockPermissionDescriptor.decode = function(decoder) {
    var packed;
    var val = new WakeLockPermissionDescriptor();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  WakeLockPermissionDescriptor.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(WakeLockPermissionDescriptor.encodedSize);
    encoder.writeUint32(0);
  ...
  Object.defineProperty(PermissionDescriptorExtension.prototype, "wakeLock", {
    get: function() {
      if (this.$tag != PermissionDescriptorExtension.Tags.wakeLock) {
        throw new ReferenceError(
            "PermissionDescriptorExtension.wakeLock is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = PermissionDescriptorExtension.Tags.wakeLock;
      this.$data = value;
    }
  });
    ...
    PermissionDescriptorExtension.encode = function(encoder, val) {
      ...
      switch (val.$tag) {
        ...
        case PermissionDescriptorExtension.Tags.clipboard:
          ...
          break;
        case PermissionDescriptorExtension.Tags.wakeLock:
          encoder.encodeStructPointer(WakeLockPermissionDescriptor, val.wakeLock);
          break;
      }
      encoder.align();
    };
    ...
    PermissionDescriptorExtension.decode = function(decoder) {
      ...
      switch (tag) {
        ...
        case PermissionDescriptorExtension.Tags.clipboard:
          ...
          break;
        case PermissionDescriptorExtension.Tags.wakeLock:
          result.wakeLock = decoder.decodeStructPointer(WakeLockPermissionDescriptor);
          break;
      }
      decoder.align();
    ...
    // validate PermissionDescriptorExtension.wakeLock
    err = messageValidator.validateStructPointer(data_offset, WakeLockPermissionDescriptor, false);
    if (err !== validator.validationError.NONE)
        return err;
          break;
      }
  ...
  exports.WakeLockPermissionDescriptor = WakeLockPermissionDescriptor;
