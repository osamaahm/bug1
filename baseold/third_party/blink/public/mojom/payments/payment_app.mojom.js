...
(function() {
  ...
  PaymentEventResponseType.PAYMENT_EVENT_SUCCESS = 0;
  PaymentEventResponseType.PAYMENT_EVENT_REJECT = PaymentEventResponseType.PAYMENT_EVENT_SUCCESS + 1;
  PaymentEventResponseType.PAYMENT_EVENT_SERVICE_WORKER_ERROR = PaymentEventResponseType.PAYMENT_EVENT_REJECT + 1;
  PaymentEventResponseType.PAYMENT_HANDLER_WINDOW_CLOSING = PaymentEventResponseType.PAYMENT_EVENT_SERVICE_WORKER_ERROR + 1;
  PaymentEventResponseType.PAYMENT_EVENT_INTERNAL_ERROR = PaymentEventResponseType.PAYMENT_HANDLER_WINDOW_CLOSING + 1;
  PaymentEventResponseType.PAYMENT_EVENT_NO_RESPONSE = PaymentEventResponseType.PAYMENT_EVENT_INTERNAL_ERROR + 1;
  PaymentEventResponseType.PAYMENT_DETAILS_STRINGIFY_ERROR = PaymentEventResponseType.PAYMENT_EVENT_NO_RESPONSE + 1;
  PaymentEventResponseType.PAYMENT_METHOD_NAME_EMPTY = PaymentEventResponseType.PAYMENT_DETAILS_STRINGIFY_ERROR + 1;
  PaymentEventResponseType.PAYMENT_DETAILS_ABSENT = PaymentEventResponseType.PAYMENT_METHOD_NAME_EMPTY + 1;
  PaymentEventResponseType.PAYMENT_DETAILS_NOT_OBJECT = PaymentEventResponseType.PAYMENT_DETAILS_ABSENT + 1;
  PaymentEventResponseType.PAYMENT_EVENT_BROWSER_ERROR = PaymentEventResponseType.PAYMENT_DETAILS_NOT_OBJECT + 1;
  PaymentEventResponseType.PAYMENT_EVENT_TIMEOUT = PaymentEventResponseType.PAYMENT_EVENT_BROWSER_ERROR + 1;
  PaymentEventResponseType.PAYMENT_HANDLER_INSECURE_NAVIGATION = PaymentEventResponseType.PAYMENT_EVENT_TIMEOUT + 1;
  PaymentEventResponseType.PAYER_NAME_EMPTY = PaymentEventResponseType.PAYMENT_HANDLER_INSECURE_NAVIGATION + 1;
  PaymentEventResponseType.PAYER_EMAIL_EMPTY = PaymentEventResponseType.PAYER_NAME_EMPTY + 1;
  PaymentEventResponseType.PAYER_PHONE_EMPTY = PaymentEventResponseType.PAYER_EMAIL_EMPTY + 1;
  PaymentEventResponseType.SHIPPING_ADDRESS_INVALID = PaymentEventResponseType.PAYER_PHONE_EMPTY + 1;
  PaymentEventResponseType.SHIPPING_OPTION_EMPTY = PaymentEventResponseType.SHIPPING_ADDRESS_INVALID + 1;
  PaymentEventResponseType.MIN_VALUE = 0,
  PaymentEventResponseType.MAX_VALUE = 17,
  ...
  PaymentDelegation.PAYER_NAME = PaymentDelegation.SHIPPING_ADDRESS + 1;
  PaymentDelegation.PAYER_PHONE = PaymentDelegation.PAYER_NAME + 1;
  PaymentDelegation.PAYER_EMAIL = PaymentDelegation.PAYER_PHONE + 1;
  ...
  PaymentRequestEventData.decode = function(decoder) {
    ...
    val.paymentOptions = decoder.decodeStructPointer(payment_request$.PaymentOptions);
    val.shippingOptions = decoder.decodeArrayPointer(new codec.PointerTo(payment_request$.PaymentShippingOption));
  ...
  PaymentManager_EnableDelegations_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.delegations = decoder.decodeArrayPointer(new codec.Enum(PaymentDelegation));
    return val;
  };
