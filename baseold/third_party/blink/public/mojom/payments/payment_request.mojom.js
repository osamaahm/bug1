...
(function() {
  ...
  PaymentMethodData.validate = function(messageValidator, offset) {
    ...
    // validate PaymentMethodData.gpayBridgeData
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, GooglePaymentMethodData, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate PaymentMethodData.environment
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 24, AndroidPayEnvironment);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 4, new codec.Enum(BasicCardNetwork), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate PaymentMethodData.supportedTypes
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 48, 4, new codec.Enum(BasicCardType), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  PaymentMethodData.encodedSize = codec.kStructHeaderSize + 56;
  ...
  PaymentMethodData.decode = function(decoder) {
    ...
    val.stringifiedData = decoder.decodeStruct(codec.String);
    val.gpayBridgeData = decoder.decodeStructPointer(GooglePaymentMethodData);
  ...
  PaymentMethodData.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.String, val.stringifiedData);
    encoder.encodeStructPointer(GooglePaymentMethodData, val.gpayBridgeData);
  ...
  PaymentRequest_Init_Params.prototype.initDefaults_ = function() {
    ...
    this.details = null;
    this.options = null;
    this.googlePayBridgeEligible = false;
  };
  ...
  PaymentRequest_Init_Params.encodedSize = codec.kStructHeaderSize + 40;
  ...
  PaymentRequest_Init_Params.decode = function(decoder) {
    ...
    packed = decoder.readUint8();
    val.googlePayBridgeEligible = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PaymentRequest_Init_Params.encode = function(encoder, val) {
    ...
    packed = 0;
    packed |= (val.googlePayBridgeEligible & 1) << 0
    encoder.writeUint8(packed);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  PaymentRequestProxy.prototype.init = function(client, methodData, details, options, googlePayBridgeEligible) {
    var params_ = new PaymentRequest_Init_Params();
    params_.client = client;
    params_.methodData = methodData;
    params_.details = details;
    params_.options = options;
    params_.googlePayBridgeEligible = googlePayBridgeEligible;
    var builder = new codec.MessageV0Builder(
  ...
  PaymentRequestStub.prototype.init = function(client, methodData, details, options, googlePayBridgeEligible) {
    return this.delegate_ && this.delegate_.init && this.delegate_.init(client, methodData, details, options, googlePayBridgeEligible);
  }
  ...
  PaymentRequestStub.prototype.accept = function(message) {
    ...
    case kPaymentRequest_Init_Name:
      ...
      this.init(params.client, params.methodData, params.details, params.options, params.googlePayBridgeEligible);
      return true;
