...
(function() {
  ...
  DevToolsAgent_AttachDevToolsSession_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  DevToolsAgentProxy.prototype.attachDevToolsSession = function(host, session, ioSession, reattachSessionState, clientExpectsBinaryResponses) {
  ...
  DevToolsAgentStub.prototype.attachDevToolsSession = function(host, session, ioSession, reattachSessionState, clientExpectsBinaryResponses) {
    return this.delegate_ && this.delegate_.attachDevToolsSession && this.delegate_.attachDevToolsSession(host, session, ioSession, reattachSessionState, clientExpectsBinaryResponses);
  }
  ...
  DevToolsAgentStub.prototype.accept = function(message) {
    ...
    case kDevToolsAgent_AttachDevToolsSession_Name:
      ...
      this.attachDevToolsSession(params.host, params.session, params.ioSession, params.reattachSessionState, params.clientExpectsBinaryResponses);
      return true;
