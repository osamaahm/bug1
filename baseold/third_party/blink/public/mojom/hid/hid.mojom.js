...
(function() {
  ...
  VendorAndProduct.decode = function(decoder) {
    ...
    val.vendor = decoder.decodeStruct(codec.Uint16);
    val.product = decoder.decodeStruct(codec.Uint16);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  HidDeviceFilter.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.deviceIds = decoder.decodeStruct(DeviceIdFilter);
    val.usage = decoder.decodeStruct(UsageFilter);
    return val;
  };
  ...
  HidService_GetDevices_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.devices = decoder.decodeArrayPointer(new codec.PointerTo(hid$.HidDeviceInfo));
    return val;
  };
  ...
  HidService_RequestDevice_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.filters = decoder.decodeArrayPointer(new codec.PointerTo(HidDeviceFilter));
    return val;
  };
  ...
  HidService_RequestDevice_ResponseParams.validate = function(messageValidator, offset) {
    ...
    // validate HidService_RequestDevice_ResponseParams.device
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, hid$.HidDeviceInfo, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  HidService_RequestDevice_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.device = decoder.decodeStructPointer(hid$.HidDeviceInfo);
    return val;
  };
  ...
  HidService_RequestDevice_ResponseParams.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeStructPointer(hid$.HidDeviceInfo, val.device);
  };
  ...
  HidService_Connect_Params.decode = function(decoder) {
    ...
    val.client = decoder.decodeStruct(new codec.Interface(hid$.HidConnectionClientPtr));
    return val;
  };
  ...
  HidService_Connect_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.connection = decoder.decodeStruct(new codec.NullableInterface(hid$.HidConnectionPtr));
    return val;
  };
  ...
  var kHidService_GetDevices_Name = 0;
  var kHidService_RequestDevice_Name = 1;
  var kHidService_Connect_Name = 2;
