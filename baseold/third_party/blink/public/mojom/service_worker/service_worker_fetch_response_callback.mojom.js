...
(function() {
  ...
  ServiceWorkerFetchEventTiming.decode = function(decoder) {
    ...
    val.dispatchEventTime = decoder.decodeStructPointer(time$.TimeTicks);
    val.respondWithSettledTime = decoder.decodeStructPointer(time$.TimeTicks);
    return val;
  };
  ...
  ServiceWorkerFetchResponseCallback_OnResponse_Params.decode = function(decoder) {
    ...
    val.timing = decoder.decodeStructPointer(ServiceWorkerFetchEventTiming);
    return val;
  };
