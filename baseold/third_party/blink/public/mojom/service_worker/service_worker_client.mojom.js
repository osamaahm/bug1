...
(function() {
  ...
  ServiceWorkerClientType.kDedicatedWorker = ServiceWorkerClientType.kWindow + 1;
  ServiceWorkerClientType.kSharedWorker = ServiceWorkerClientType.kDedicatedWorker + 1;
  ...
  ServiceWorkerClientLifecycleState.kFrozen = ServiceWorkerClientLifecycleState.kActive + 1;
  ...
  ServiceWorkerClientInfo.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.lifecycleState = decoder.decodeStruct(codec.Int32);
