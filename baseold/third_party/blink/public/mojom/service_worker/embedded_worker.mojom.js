...
(function() {
  ...
  EmbeddedWorkerStartParams.prototype.initDefaults_ = function() {
    ...
    this.preferenceWatcherRequest = new bindings.InterfaceRequest();
  ...
  EmbeddedWorkerStartParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, renderer_preferences$.RendererPreferences, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate EmbeddedWorkerStartParams.serviceWorkerReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 60, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate EmbeddedWorkerStartParams.controllerReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 80, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate EmbeddedWorkerStartParams.installedScriptsInfo
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, service_worker_installed_scripts_manager$.ServiceWorkerInstalledScriptsInfo, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate EmbeddedWorkerStartParams.instanceHost
    err = messageValidator.validateAssociatedInterface(offset + codec.kStructHeaderSize + 96, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate EmbeddedWorkerStartParams.providerInfo
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 104, service_worker_provider$.ServiceWorkerProviderInfoForStartWorker, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate EmbeddedWorkerStartParams.preferenceWatcherRequest
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 84, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate EmbeddedWorkerStartParams.subresourceLoaderFactories
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 120, url_loader_factory_bundle$.URLLoaderFactoryBundle, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  EmbeddedWorkerStartParams.encodedSize = codec.kStructHeaderSize + 136;
  ...
  EmbeddedWorkerStartParams.decode = function(decoder) {
    ...
    val.scriptType = decoder.decodeStruct(codec.Int32);
    val.serviceWorkerRouteId = decoder.decodeStruct(codec.Int32);
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.serviceWorkerReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    val.scriptUrlToSkipThrottling = decoder.decodeStructPointer(url$.Url);
    val.rendererPreferences = decoder.decodeStructPointer(renderer_preferences$.RendererPreferences);
    val.controllerReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    val.preferenceWatcherRequest = decoder.decodeStruct(codec.InterfaceRequest);
  ...
  EmbeddedWorkerStartParams.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.InterfaceRequest, val.preferenceWatcherRequest);
  ...
  EmbeddedWorkerStartTiming.decode = function(decoder) {
    ...
    val.scriptEvaluationStartTime = decoder.decodeStructPointer(time$.TimeTicks);
    val.scriptEvaluationEndTime = decoder.decodeStructPointer(time$.TimeTicks);
    return val;
  };
  ...
  EmbeddedWorkerInstanceHost_OnReadyForInspection_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.agent = decoder.decodeStruct(new codec.Interface(devtools_agent$.DevToolsAgentPtr));
    val.agentHost = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  EmbeddedWorkerInstanceHost_OnStarted_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, EmbeddedWorkerStartTiming, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  EmbeddedWorkerInstanceHost_OnStarted_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  var kEmbeddedWorkerInstanceClient_ResumeAfterDownload_Name = 2;
  ...
  EmbeddedWorkerInstanceHostProxy.prototype.onStarted = function(status, threadId, startTiming) {
  ...
  EmbeddedWorkerInstanceHostStub.prototype.onStarted = function(status, threadId, startTiming) {
    return this.delegate_ && this.delegate_.onStarted && this.delegate_.onStarted(status, threadId, startTiming);
  }
  ...
  EmbeddedWorkerInstanceHostStub.prototype.accept = function(message) {
    ...
    case kEmbeddedWorkerInstanceHost_OnStarted_Name:
      ...
      this.onStarted(params.status, params.threadId, params.startTiming);
      return true;
