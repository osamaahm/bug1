...
(function() {
  ...
  ServiceWorkerInstalledScriptsInfo.decode = function(decoder) {
    ...
    val.managerReceiver = decoder.decodeStruct(codec.InterfaceRequest);
    val.managerHostRemote = decoder.decodeStruct(new codec.Interface(ServiceWorkerInstalledScriptsManagerHostPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
