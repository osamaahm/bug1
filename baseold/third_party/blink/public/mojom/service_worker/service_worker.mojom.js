...
(function() {
  ...
  FetchHandlerExistence.EXISTS = FetchHandlerExistence.UNKNOWN + 1;
  FetchHandlerExistence.DOES_NOT_EXIST = FetchHandlerExistence.EXISTS + 1;
  ...
  ServiceWorker_InitializeGlobalScope_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 16, service_worker_object$.ServiceWorkerObjectInfo, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate ServiceWorker_InitializeGlobalScope_Params.fetchHandlerExistence
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 24, FetchHandlerExistence);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ServiceWorker_InitializeGlobalScope_Params.encodedSize = codec.kStructHeaderSize + 32;
  ...
  ServiceWorker_InitializeGlobalScope_Params.decode = function(decoder) {
    ...
    val.serviceWorkerInfo = decoder.decodeStructPointer(service_worker_object$.ServiceWorkerObjectInfo);
    val.fetchHandlerExistence = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ServiceWorker_DispatchBackgroundFetchAbortEvent_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.registration = decoder.decodeStructPointer(background_fetch$.BackgroundFetchRegistration);
    return val;
  };
  ...
  ServiceWorker_DispatchCookieChangeEvent_Params.validate = function(messageValidator, offset) {
    ...
    // validate ServiceWorker_DispatchCookieChangeEvent_Params.cookie
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, cookie_manager$.CanonicalCookie, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate ServiceWorker_DispatchCookieChangeEvent_Params.cause
  ...
  ServiceWorker_DispatchCookieChangeEvent_Params.encodedSize = codec.kStructHeaderSize + 16;
  ...
  ServiceWorker_DispatchPushEvent_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.payload = decoder.decodeStruct(codec.NullableString);
    return val;
  };
  ...
  ServiceWorker_DispatchPushSubscriptionChangeEvent_Params.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, push_messaging$.PushSubscription, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate ServiceWorker_DispatchPushSubscriptionChangeEvent_Params.newSubscription
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 8, push_messaging$.PushSubscription, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ServiceWorker_DispatchPushSubscriptionChangeEvent_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.oldSubscription = decoder.decodeStructPointer(push_messaging$.PushSubscription);
    val.newSubscription = decoder.decodeStructPointer(push_messaging$.PushSubscription);
    return val;
  };
  ...
  function ServiceWorker_SetIdleTimerDelayToZero_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ServiceWorker_SetIdleTimerDelayToZero_Params.prototype.initDefaults_ = function() {
  };
  ServiceWorker_SetIdleTimerDelayToZero_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  ServiceWorker_SetIdleTimerDelayToZero_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  ServiceWorker_SetIdleTimerDelayToZero_Params.encodedSize = codec.kStructHeaderSize + 0;

  ServiceWorker_SetIdleTimerDelayToZero_Params.decode = function(decoder) {
    var packed;
    var val = new ServiceWorker_SetIdleTimerDelayToZero_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  ServiceWorker_SetIdleTimerDelayToZero_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ServiceWorker_SetIdleTimerDelayToZero_Params.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kServiceWorkerHost_SetCachedMetadata_Name = 0;
  var kServiceWorkerHost_ClearCachedMetadata_Name = 1;
  var kServiceWorkerHost_GetClients_Name = 2;
  var kServiceWorkerHost_GetClient_Name = 3;
  var kServiceWorkerHost_OpenNewTab_Name = 4;
  var kServiceWorkerHost_OpenPaymentHandlerWindow_Name = 5;
  var kServiceWorkerHost_PostMessageToClient_Name = 6;
  var kServiceWorkerHost_FocusClient_Name = 7;
  var kServiceWorkerHost_NavigateClient_Name = 8;
  var kServiceWorkerHost_SkipWaiting_Name = 9;
  var kServiceWorkerHost_ClaimClients_Name = 10;
  ...
  var kServiceWorker_InitializeGlobalScope_Name = 0;
  var kServiceWorker_DispatchInstallEvent_Name = 1;
  var kServiceWorker_DispatchActivateEvent_Name = 2;
  var kServiceWorker_DispatchBackgroundFetchAbortEvent_Name = 3;
  var kServiceWorker_DispatchBackgroundFetchClickEvent_Name = 4;
  var kServiceWorker_DispatchBackgroundFetchFailEvent_Name = 5;
  var kServiceWorker_DispatchBackgroundFetchSuccessEvent_Name = 6;
  var kServiceWorker_DispatchCookieChangeEvent_Name = 7;
  var kServiceWorker_DispatchFetchEventForMainResource_Name = 8;
  var kServiceWorker_DispatchNotificationClickEvent_Name = 9;
  var kServiceWorker_DispatchNotificationCloseEvent_Name = 10;
  var kServiceWorker_DispatchPushEvent_Name = 11;
  var kServiceWorker_DispatchPushSubscriptionChangeEvent_Name = 12;
  var kServiceWorker_DispatchSyncEvent_Name = 13;
  var kServiceWorker_DispatchPeriodicSyncEvent_Name = 14;
  var kServiceWorker_DispatchAbortPaymentEvent_Name = 15;
  var kServiceWorker_DispatchCanMakePaymentEvent_Name = 16;
  var kServiceWorker_DispatchPaymentRequestEvent_Name = 17;
  var kServiceWorker_DispatchExtendableMessageEvent_Name = 18;
  var kServiceWorker_DispatchContentDeleteEvent_Name = 19;
  var kServiceWorker_Ping_Name = 20;
  var kServiceWorker_SetIdleTimerDelayToZero_Name = 21;
  var kServiceWorker_AddMessageToConsole_Name = 22;
  ...
  ServiceWorkerProxy.prototype.initializeGlobalScope = function(serviceWorkerHost, registrationInfo, serviceWorkerInfo, fetchHandlerExistence) {
  ...
  ServiceWorkerProxy.prototype.dispatchCookieChangeEvent = function(cookie, cause) {
  ...
  ServiceWorkerPtr.prototype.setIdleTimerDelayToZero = function() {
    return ServiceWorkerProxy.prototype.setIdleTimerDelayToZero
        .apply(this.ptr.getProxy(), arguments);
  };

  ServiceWorkerProxy.prototype.setIdleTimerDelayToZero = function() {
    var params_ = new ServiceWorker_SetIdleTimerDelayToZero_Params();
    var builder = new codec.MessageV0Builder(
        kServiceWorker_SetIdleTimerDelayToZero_Name,
        codec.align(ServiceWorker_SetIdleTimerDelayToZero_Params.encodedSize));
    builder.encodeStruct(ServiceWorker_SetIdleTimerDelayToZero_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  ServiceWorkerStub.prototype.initializeGlobalScope = function(serviceWorkerHost, registrationInfo, serviceWorkerInfo, fetchHandlerExistence) {
    return this.delegate_ && this.delegate_.initializeGlobalScope && this.delegate_.initializeGlobalScope(serviceWorkerHost, registrationInfo, serviceWorkerInfo, fetchHandlerExistence);
  }
  ...
  ServiceWorkerStub.prototype.dispatchCookieChangeEvent = function(cookie, cause) {
  ...
  ServiceWorkerStub.prototype.setIdleTimerDelayToZero = function() {
  ...
  ServiceWorkerStub.prototype.accept = function(message) {
    ...
    case kServiceWorker_InitializeGlobalScope_Name:
      ...
      this.initializeGlobalScope(params.serviceWorkerHost, params.registrationInfo, params.serviceWorkerInfo, params.fetchHandlerExistence);
      return true;
    case kServiceWorker_SetIdleTimerDelayToZero_Name:
      var params = reader.decodeStruct(ServiceWorker_SetIdleTimerDelayToZero_Params);
  ...
  function validateServiceWorkerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kServiceWorker_SetIdleTimerDelayToZero_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = ServiceWorker_SetIdleTimerDelayToZero_Params;
      break;
      case kServiceWorker_AddMessageToConsole_Name:
        if (!message.expectsResponse() && !message.isResponse())
