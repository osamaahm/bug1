...
(function() {
  ...
  CredentialManagerError.INVALID_DOMAIN = CredentialManagerError.NOT_ALLOWED + 1;
  CredentialManagerError.INVALID_ICON_URL = CredentialManagerError.INVALID_DOMAIN + 1;
  CredentialManagerError.CREDENTIAL_EXCLUDED = CredentialManagerError.INVALID_ICON_URL + 1;
  ...
  CredentialManagerError.RESIDENT_CREDENTIALS_UNSUPPORTED = CredentialManagerError.NOT_FOCUSED + 1;
  CredentialManagerError.PROTECTION_POLICY_INCONSISTENT = CredentialManagerError.RESIDENT_CREDENTIALS_UNSUPPORTED + 1;
  CredentialManagerError.ANDROID_ALGORITHM_UNSUPPORTED = CredentialManagerError.PROTECTION_POLICY_INCONSISTENT + 1;
  CredentialManagerError.ANDROID_EMPTY_ALLOW_CREDENTIALS = CredentialManagerError.ANDROID_ALGORITHM_UNSUPPORTED + 1;
  CredentialManagerError.ANDROID_NOT_SUPPORTED_ERROR = CredentialManagerError.ANDROID_EMPTY_ALLOW_CREDENTIALS + 1;
  CredentialManagerError.ANDROID_USER_VERIFICATION_UNSUPPORTED = CredentialManagerError.ANDROID_NOT_SUPPORTED_ERROR + 1;
  CredentialManagerError.ABORT = CredentialManagerError.ANDROID_USER_VERIFICATION_UNSUPPORTED + 1;
  CredentialManagerError.UNKNOWN = CredentialManagerError.ABORT + 1;
  CredentialManagerError.MIN_VALUE = 0,
  CredentialManagerError.MAX_VALUE = 17,
