...
(function() {
  ...
  MediaStreamType.DEVICE_AUDIO_CAPTURE = MediaStreamType.NO_SERVICE + 1;
  MediaStreamType.DEVICE_VIDEO_CAPTURE = MediaStreamType.DEVICE_AUDIO_CAPTURE + 1;
  MediaStreamType.GUM_TAB_AUDIO_CAPTURE = MediaStreamType.DEVICE_VIDEO_CAPTURE + 1;
  MediaStreamType.GUM_TAB_VIDEO_CAPTURE = MediaStreamType.GUM_TAB_AUDIO_CAPTURE + 1;
  MediaStreamType.GUM_DESKTOP_VIDEO_CAPTURE = MediaStreamType.GUM_TAB_VIDEO_CAPTURE + 1;
  MediaStreamType.GUM_DESKTOP_AUDIO_CAPTURE = MediaStreamType.GUM_DESKTOP_VIDEO_CAPTURE + 1;
  MediaStreamType.DISPLAY_VIDEO_CAPTURE = MediaStreamType.GUM_DESKTOP_AUDIO_CAPTURE + 1;
  MediaStreamType.DISPLAY_AUDIO_CAPTURE = MediaStreamType.DISPLAY_VIDEO_CAPTURE + 1;
  MediaStreamType.NUM_MEDIA_TYPES = MediaStreamType.DISPLAY_AUDIO_CAPTURE + 1;
  ...
  MediaStreamRequestResult.NUM_MEDIA_REQUEST_RESULTS = MediaStreamRequestResult.SYSTEM_PERMISSION_DENIED + 1;
  ...
  StreamSelectionStrategy.SEARCH_BY_DEVICE_ID = StreamSelectionStrategy.SEARCH_BY_SESSION_ID + 1;
  StreamSelectionStrategy.FORCE_NEW_STREAM = StreamSelectionStrategy.SEARCH_BY_DEVICE_ID + 1;
  ...
  StreamSelectionInfo.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.sessionId = decoder.decodeStructPointer(unguessable_token$.UnguessableToken);
    return val;
  };
  ...
  MediaStreamDispatcherHost_GenerateStream_Params.decode = function(decoder) {
    ...
    val.audioStreamSelectionInfo = decoder.decodeStructPointer(StreamSelectionInfo);
    return val;
  };
