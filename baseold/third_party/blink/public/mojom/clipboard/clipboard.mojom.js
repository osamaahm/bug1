...
(function() {
  ...
  function ClipboardHost_WriteRawData_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  ClipboardHost_WriteRawData_Params.prototype.initDefaults_ = function() {
    this.format = null;
    this.data = null;
  };
  ClipboardHost_WriteRawData_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  ClipboardHost_WriteRawData_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate ClipboardHost_WriteRawData_Params.format
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, string16$.String16, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate ClipboardHost_WriteRawData_Params.data
  ...
  ClipboardHost_WriteRawData_Params.encodedSize = codec.kStructHeaderSize + 24;

  ClipboardHost_WriteRawData_Params.decode = function(decoder) {
    var packed;
    var val = new ClipboardHost_WriteRawData_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.format = decoder.decodeStructPointer(string16$.String16);
    val.data = decoder.decodeStruct(big_buffer$.BigBuffer);
    return val;
  };

  ClipboardHost_WriteRawData_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(ClipboardHost_WriteRawData_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  var kClipboardHost_WriteRawData_Name = 12;
  var kClipboardHost_WriteBookmark_Name = 13;
  var kClipboardHost_WriteImage_Name = 14;
  var kClipboardHost_CommitWrite_Name = 15;
  ...
  ClipboardHostPtr.prototype.writeRawData = function() {
    return ClipboardHostProxy.prototype.writeRawData
        .apply(this.ptr.getProxy(), arguments);
  };

  ClipboardHostProxy.prototype.writeRawData = function(format, data) {
    var params_ = new ClipboardHost_WriteRawData_Params();
    params_.format = format;
    params_.data = data;
    var builder = new codec.MessageV0Builder(
        kClipboardHost_WriteRawData_Name,
        codec.align(ClipboardHost_WriteRawData_Params.encodedSize));
    builder.encodeStruct(ClipboardHost_WriteRawData_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  ClipboardHostStub.prototype.writeRawData = function(format, data) {
    return this.delegate_ && this.delegate_.writeRawData && this.delegate_.writeRawData(format, data);
  }
  ...
  ClipboardHostStub.prototype.accept = function(message) {
    ...
    case kClipboardHost_WriteCustomData_Name:
      ...
      return true;
    case kClipboardHost_WriteRawData_Name:
      var params = reader.decodeStruct(ClipboardHost_WriteRawData_Params);
      this.writeRawData(params.format, params.data);
      return true;
  ...
  function validateClipboardHostRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kClipboardHost_WriteRawData_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = ClipboardHost_WriteRawData_Params;
      break;
      case kClipboardHost_WriteBookmark_Name:
        if (!message.expectsResponse() && !message.isResponse())
