...
(function() {
  ...
  function MediaParser_ExtractVideoFrame_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  MediaParser_ExtractVideoFrame_Params.prototype.initDefaults_ = function() {
    this.mimeType = null;
    this.totalSize = 0;
    this.mediaDataSource = new MediaDataSourcePtr();
  };
  MediaParser_ExtractVideoFrame_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  MediaParser_ExtractVideoFrame_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate MediaParser_ExtractVideoFrame_Params.mimeType
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate MediaParser_ExtractVideoFrame_Params.mediaDataSource
  ...
  MediaParser_ExtractVideoFrame_Params.encodedSize = codec.kStructHeaderSize + 24;

  MediaParser_ExtractVideoFrame_Params.decode = function(decoder) {
    var packed;
    var val = new MediaParser_ExtractVideoFrame_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.mimeType = decoder.decodeStruct(codec.String);
    val.totalSize = decoder.decodeStruct(codec.Uint32);
    val.mediaDataSource = decoder.decodeStruct(new codec.Interface(MediaDataSourcePtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  MediaParser_ExtractVideoFrame_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(MediaParser_ExtractVideoFrame_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.mimeType);
    encoder.encodeStruct(codec.Uint32, val.totalSize);
    encoder.encodeStruct(new codec.Interface(MediaDataSourcePtr), val.mediaDataSource);
    encoder.skip(1);
    encoder.skip(1);
    encoder.skip(1);
  ...
  function MediaParser_ExtractVideoFrame_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  MediaParser_ExtractVideoFrame_ResponseParams.prototype.initDefaults_ = function() {
    this.success = false;
    this.frameData = null;
    this.config = null;
  };
  MediaParser_ExtractVideoFrame_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  MediaParser_ExtractVideoFrame_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate MediaParser_ExtractVideoFrame_ResponseParams.frameData
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 8, VideoFrameData, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate MediaParser_ExtractVideoFrame_ResponseParams.config
  ...
  MediaParser_ExtractVideoFrame_ResponseParams.encodedSize = codec.kStructHeaderSize + 32;

  MediaParser_ExtractVideoFrame_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new MediaParser_ExtractVideoFrame_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    packed = decoder.readUint8();
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.frameData = decoder.decodeStruct(VideoFrameData);
    val.config = decoder.decodeStructPointer(media_types$.VideoDecoderConfig);
    return val;
  };

  MediaParser_ExtractVideoFrame_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(MediaParser_ExtractVideoFrame_ResponseParams.encodedSize);
    encoder.writeUint32(0);
    packed = 0;
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStruct(VideoFrameData, val.frameData);
  ...
  Object.defineProperty(VideoFrameData.prototype, "encodedData", {
    get: function() {
      if (this.$tag != VideoFrameData.Tags.encodedData) {
        throw new ReferenceError(
            "VideoFrameData.encodedData is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = VideoFrameData.Tags.encodedData;
      this.$data = value;
    }
  });
  Object.defineProperty(VideoFrameData.prototype, "decodedFrame", {
    get: function() {
      if (this.$tag != VideoFrameData.Tags.decodedFrame) {
        throw new ReferenceError(
            "VideoFrameData.decodedFrame is not currently set.");
      }
      return this.$data;
    },

    set: function(value) {
      this.$tag = VideoFrameData.Tags.decodedFrame;
      this.$data = value;
    }
  });
    ...
    VideoFrameData.encode = function(encoder, val) {
      ...
      switch (val.$tag) {
        case VideoFrameData.Tags.encodedData:
          encoder.encodeArrayPointer(codec.Uint8, val.encodedData);
          break;
        case VideoFrameData.Tags.decodedFrame:
          encoder.encodeStructPointer(media_types$.VideoFrame, val.decodedFrame);
          break;
      }
      encoder.align();
    };
    ...
    VideoFrameData.decode = function(decoder) {
      ...
      switch (tag) {
        case VideoFrameData.Tags.encodedData:
          result.encodedData = decoder.decodeArrayPointer(codec.Uint8);
          break;
        case VideoFrameData.Tags.decodedFrame:
          result.decodedFrame = decoder.decodeStructPointer(media_types$.VideoFrame);
          break;
      }
      decoder.align();
    ...
    // validate VideoFrameData.encodedData
    ...
    // validate VideoFrameData.decodedFrame
    err = messageValidator.validateStructPointer(data_offset, media_types$.VideoFrame, true);
    if (err !== validator.validationError.NONE)
        return err;
          break;
      }
  ...
  var kMediaParser_ParseMediaMetadata_Name = 0;
  var kMediaParser_ExtractVideoFrame_Name = 1;
  var kMediaParser_CheckMediaFile_Name = 2;
  var kMediaParser_GetCpuInfo_Name = 3;
  ...
  MediaParserPtr.prototype.extractVideoFrame = function() {
    return MediaParserProxy.prototype.extractVideoFrame
        .apply(this.ptr.getProxy(), arguments);
  };

  MediaParserProxy.prototype.extractVideoFrame = function(mimeType, totalSize, mediaDataSource) {
    var params_ = new MediaParser_ExtractVideoFrame_Params();
    params_.mimeType = mimeType;
    params_.totalSize = totalSize;
    params_.mediaDataSource = mediaDataSource;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kMediaParser_ExtractVideoFrame_Name,
          codec.align(MediaParser_ExtractVideoFrame_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(MediaParser_ExtractVideoFrame_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(MediaParser_ExtractVideoFrame_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  MediaParserStub.prototype.extractVideoFrame = function(mimeType, totalSize, mediaDataSource) {
    return this.delegate_ && this.delegate_.extractVideoFrame && this.delegate_.extractVideoFrame(mimeType, totalSize, mediaDataSource);
  }
  ...
  MediaParserStub.prototype.acceptWithResponder =
    ...
    case kMediaParser_ParseMediaMetadata_Name:
      ...
      return true;
    case kMediaParser_ExtractVideoFrame_Name:
      var params = reader.decodeStruct(MediaParser_ExtractVideoFrame_Params);
      this.extractVideoFrame(params.mimeType, params.totalSize, params.mediaDataSource).then(function(response) {
        var responseParams =
            new MediaParser_ExtractVideoFrame_ResponseParams();
        responseParams.success = response.success;
        responseParams.frameData = response.frameData;
        responseParams.config = response.config;
        var builder = new codec.MessageV1Builder(
            kMediaParser_ExtractVideoFrame_Name,
            codec.align(MediaParser_ExtractVideoFrame_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(MediaParser_ExtractVideoFrame_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateMediaParserRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kMediaParser_ExtractVideoFrame_Name:
        if (message.expectsResponse())
          paramsClass = MediaParser_ExtractVideoFrame_Params;
      break;
      case kMediaParser_CheckMediaFile_Name:
        if (message.expectsResponse())
  ...
  function validateMediaParserResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kMediaParser_ExtractVideoFrame_Name:
        if (message.isResponse())
          paramsClass = MediaParser_ExtractVideoFrame_ResponseParams;
        break;
      case kMediaParser_CheckMediaFile_Name:
        if (message.isResponse())
  ...
  var kMediaParserFactory_CreateMediaParser_Name = 0;
  ...
  var kMediaDataSource_Read_Name = 0;
