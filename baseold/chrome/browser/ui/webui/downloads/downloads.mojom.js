...
(function() {
  ...
  Data.decode = function(decoder) {
    ...
    val.otr = (packed >> 1) & 1 ? true : false;
    val.resume = (packed >> 2) & 1 ? true : false;
    val.retry = (packed >> 3) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.percent = decoder.decodeStruct(codec.Int32);
    val.started = decoder.decodeStruct(codec.Int32);
    val.total = decoder.decodeStruct(codec.Int32);
    val.byExtId = decoder.decodeStruct(codec.String);
    val.byExtName = decoder.decodeStruct(codec.String);
    val.dangerType = decoder.decodeStruct(codec.String);
    val.dateString = decoder.decodeStruct(codec.String);
    val.fileName = decoder.decodeStruct(codec.String);
    val.filePath = decoder.decodeStruct(codec.String);
    val.fileUrl = decoder.decodeStruct(codec.String);
    val.id = decoder.decodeStruct(codec.String);
    val.lastReasonText = decoder.decodeStruct(codec.String);
    val.progressStatusText = decoder.decodeStruct(codec.String);
    val.sinceString = decoder.decodeStruct(codec.String);
  ...
  Data.encode = function(encoder, val) {
    ...
    packed |= (val.otr & 1) << 1
    packed |= (val.resume & 1) << 2
    packed |= (val.retry & 1) << 3
  ...
  PageHandlerFactory_CreatePageHandler_Params.decode = function(decoder) {
    ...
    val.handler = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  PageHandler_GetDownloads_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.searchTerms = decoder.decodeArrayPointer(codec.String);
    return val;
  };
  ...
  Page_UpdateItem_Params.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.data = decoder.decodeStructPointer(Data);
    return val;
  };
  ...
  Page_InsertItems_Params.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.items = decoder.decodeArrayPointer(new codec.PointerTo(Data));
    return val;
  };
  ...
  var kPageHandler_GetDownloads_Name = 0;
  var kPageHandler_OpenFileRequiringGesture_Name = 1;
  var kPageHandler_Drag_Name = 2;
  var kPageHandler_SaveDangerousRequiringGesture_Name = 3;
  var kPageHandler_DiscardDangerous_Name = 4;
  var kPageHandler_RetryDownload_Name = 5;
  var kPageHandler_Show_Name = 6;
  var kPageHandler_Pause_Name = 7;
  var kPageHandler_Resume_Name = 8;
  var kPageHandler_Remove_Name = 9;
  var kPageHandler_Undo_Name = 10;
  var kPageHandler_Cancel_Name = 11;
  var kPageHandler_ClearAll_Name = 12;
  var kPageHandler_OpenDownloadsFolderRequiringGesture_Name = 13;
  ...
  var kPage_RemoveItem_Name = 0;
  var kPage_UpdateItem_Name = 1;
  var kPage_InsertItems_Name = 2;
  var kPage_ClearAll_Name = 3;
