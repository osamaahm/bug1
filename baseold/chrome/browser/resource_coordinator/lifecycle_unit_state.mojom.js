...
(function() {
  ...
  LifecycleUnitState.PENDING_FREEZE = 2;
  LifecycleUnitState.FROZEN = 3;
  LifecycleUnitState.PENDING_DISCARD = 4;
  LifecycleUnitState.DISCARDED = 5;
  LifecycleUnitState.PENDING_UNFREEZE = 6;
  LifecycleUnitState.MIN_VALUE = 0,
  LifecycleUnitState.MAX_VALUE = 6,
  ...
  LifecycleUnitDiscardReason.PROACTIVE = 1;
  LifecycleUnitDiscardReason.URGENT = 2;
  LifecycleUnitDiscardReason.MIN_VALUE = 0,
  LifecycleUnitDiscardReason.MAX_VALUE = 2,
