...
(function() {
  ...
  MediaStatus.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 8, new codec.PointerTo(MediaImage), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  MediaStatus.decode = function(decoder) {
    ...
    val.images = decoder.decodeArrayPointer(new codec.PointerTo(MediaImage));
    return val;
  };
