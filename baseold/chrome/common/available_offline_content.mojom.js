...
(function() {
  ...
  AvailableOfflineContent.decode = function(decoder) {
    ...
    val.nameSpace = decoder.decodeStruct(codec.String);
    val.title = decoder.decodeStruct(codec.String);
    val.snippet = decoder.decodeStruct(codec.String);
    val.dateModified = decoder.decodeStruct(codec.String);
    val.attribution = decoder.decodeStruct(codec.String);
    val.thumbnailDataUri = decoder.decodeStructPointer(url$.Url);
    val.faviconDataUri = decoder.decodeStructPointer(url$.Url);
  ...
  AvailableOfflineContentProvider_List_ResponseParams.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.out = decoder.decodeArrayPointer(new codec.PointerTo(AvailableOfflineContent));
    return val;
  };
  ...
  AvailableOfflineContentProvider_LaunchItem_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.itemId = decoder.decodeStruct(codec.String);
    val.nameSpace = decoder.decodeStruct(codec.String);
    return val;
  };
  ...
  var kAvailableOfflineContentProvider_List_Name = 0;
  var kAvailableOfflineContentProvider_LaunchItem_Name = 1;
  var kAvailableOfflineContentProvider_LaunchDownloadsPage_Name = 2;
  var kAvailableOfflineContentProvider_ListVisibilityChanged_Name = 3;
