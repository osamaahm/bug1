...
(function() {
  ...
  WebRtcLoggingClient_OnAddMessages_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.messages = decoder.decodeArrayPointer(new codec.PointerTo(WebRtcLoggingMessage));
    return val;
  };
  ...
  WebRtcLoggingAgent_Start_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.client = decoder.decodeStruct(new codec.Interface(WebRtcLoggingClientPtr));
    return val;
  };
