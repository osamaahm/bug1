// gpu/ipc/common/gpu_extra_info.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  var mojomId = 'gpu/ipc/common/gpu_extra_info.mojom';
  ...
  ANGLEFeature.decode = function(decoder) {
    ...
    val.category = decoder.decodeStruct(codec.String);
    val.description = decoder.decodeStruct(codec.String);
    val.bug = decoder.decodeStruct(codec.String);
    val.status = decoder.decodeStruct(codec.String);
    val.condition = decoder.decodeStruct(codec.String);
    return val;
  };
  ...
  GpuExtraInfo.encodedSize = codec.kStructHeaderSize + 8;
  ...
  GpuExtraInfo.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.angleFeatures = decoder.decodeArrayPointer(new codec.PointerTo(ANGLEFeature));
    return val;
  };
