...
(function() {
  ...
  FuzzEnum.FUZZ_VALUE1 = FuzzEnum.FUZZ_VALUE0 + 1;
  FuzzEnum.FUZZ_VALUE2 = FuzzEnum.FUZZ_VALUE1 + 1;
  ...
  FuzzDummyStruct.decode = function(decoder) {
    ...
    val.dummy = decoder.decodeStruct(codec.Int8);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  FuzzStruct.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 56, 1, codec.Int8, false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzPrimitiveMap
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 64, false, codec.String, codec.Int8, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzArrayMap
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 72, false, codec.String, new codec.ArrayOf(codec.String), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzUnionMap
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 80, false, new codec.Enum(FuzzEnum), FuzzUnion, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzUnionArray
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 88, 16, FuzzUnion, false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzStructArray
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 96, 8, new codec.PointerTo(FuzzStruct), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzNullableArray
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 104, 1, codec.Int8, true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate FuzzStruct.fuzzComplex
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 112, 8, new codec.MapOf(new codec.Enum(FuzzEnum), new codec.MapOf(codec.Int8, new codec.NullableArrayOf(new codec.NullablePointerTo(FuzzStruct)))), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  FuzzStruct.encodedSize = codec.kStructHeaderSize + 120;
  ...
  FuzzStruct.decode = function(decoder) {
    ...
    val.fuzzInt8 = decoder.decodeStruct(codec.Int8);
    val.fuzzUint8 = decoder.decodeStruct(codec.Uint8);
    decoder.skip(1);
    val.fuzzInt16 = decoder.decodeStruct(codec.Int16);
    val.fuzzUint16 = decoder.decodeStruct(codec.Uint16);
    val.fuzzInt32 = decoder.decodeStruct(codec.Int32);
    val.fuzzUint32 = decoder.decodeStruct(codec.Uint32);
    val.fuzzInt64 = decoder.decodeStruct(codec.Int64);
    val.fuzzUint64 = decoder.decodeStruct(codec.Uint64);
    val.fuzzFloat = decoder.decodeStruct(codec.Float);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.fuzzDouble = decoder.decodeStruct(codec.Double);
    val.fuzzString = decoder.decodeStruct(codec.String);
    val.fuzzPrimitiveArray = decoder.decodeArrayPointer(codec.Int8);
    val.fuzzPrimitiveMap = decoder.decodeMapPointer(codec.String, codec.Int8);
    val.fuzzArrayMap = decoder.decodeMapPointer(codec.String, new codec.ArrayOf(codec.String));
    val.fuzzUnionMap = decoder.decodeMapPointer(new codec.Enum(FuzzEnum), FuzzUnion);
    val.fuzzUnionArray = decoder.decodeArrayPointer(FuzzUnion);
    val.fuzzStructArray = decoder.decodeArrayPointer(new codec.PointerTo(FuzzStruct));
    val.fuzzNullableArray = decoder.decodeArrayPointer(codec.Int8);
    val.fuzzComplex = decoder.decodeArrayPointer(new codec.MapOf(new codec.Enum(FuzzEnum), new codec.MapOf(codec.Int8, new codec.NullableArrayOf(new codec.NullablePointerTo(FuzzStruct)))));
    return val;
  };
  ...
  FuzzInterface_FuzzArgs_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.a = decoder.decodeStructPointer(FuzzStruct);
    val.b = decoder.decodeStructPointer(FuzzStruct);
    return val;
  };
  ...
  var kFuzzDummyInterface_Ping_Name = 0;
  ...
  var kFuzzInterface_FuzzBasic_Name = 0;
  var kFuzzInterface_FuzzBasicResp_Name = 1;
  var kFuzzInterface_FuzzBasicSyncResp_Name = 2;
  var kFuzzInterface_FuzzArgs_Name = 3;
  var kFuzzInterface_FuzzArgsResp_Name = 4;
  var kFuzzInterface_FuzzArgsSyncResp_Name = 5;
  var kFuzzInterface_FuzzAssociated_Name = 6;
