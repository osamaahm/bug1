...
(function() {
  ...
  var TestEnum = {};
  TestEnum.VALUE_0 = 0;
  TestEnum.VALUE_1 = TestEnum.VALUE_0 + 1;
  ...
  TestStruct.decode = function(decoder) {
    ...
    val.fStruct = decoder.decodeStructPointer(NestedStruct);
    val.fNativeStruct = decoder.decodeStructPointer(TestNativeStruct);
    val.fBoolArray = decoder.decodeArrayPointer(codec.PackedBool);
    val.fInt32Array = decoder.decodeArrayPointer(codec.Int32);
    val.fEnumArray = decoder.decodeArrayPointer(new codec.Enum(TestEnum));
    val.fInterfaceArray = decoder.decodeArrayPointer(new codec.Interface(TestInterfacePtr));
    val.fNestedArray = decoder.decodeArrayPointer(new codec.ArrayOf(codec.Int32));
    val.fStructArray = decoder.decodeArrayPointer(new codec.PointerTo(NestedStruct));
    val.fUnionArray = decoder.decodeArrayPointer(TestUnion);
    val.fMap = decoder.decodeMapPointer(codec.String, codec.Int32);
    return val;
  };
  ...
  TestInterface_Echo_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.outValue = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
