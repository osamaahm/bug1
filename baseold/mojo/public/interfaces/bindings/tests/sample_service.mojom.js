...
(function() {
  ...
  Foo.decode = function(decoder) {
    ...
    val.extraBars = decoder.decodeArrayPointer(new codec.PointerTo(Bar));
    val.name = decoder.decodeStruct(codec.String);
    val.inputStreams = decoder.decodeArrayPointer(codec.Handle);
    val.outputStreams = decoder.decodeArrayPointer(codec.Handle);
    val.arrayOfArrayOfBools = decoder.decodeArrayPointer(new codec.ArrayOf(codec.PackedBool));
    val.multiArrayOfStrings = decoder.decodeArrayPointer(new codec.ArrayOf(new codec.ArrayOf(codec.String)));
    val.arrayOfBools = decoder.decodeArrayPointer(codec.PackedBool);
    return val;
  };
  ...
  Service_Frobinate_Params.decode = function(decoder) {
    ...
    val.port = decoder.decodeStruct(new codec.NullableInterface(PortPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  Port_PostMessageToPort_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.messageText = decoder.decodeStruct(codec.String);
    val.port = decoder.decodeStruct(new codec.Interface(PortPtr));
    return val;
  };
