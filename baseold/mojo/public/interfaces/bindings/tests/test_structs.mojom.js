...
(function() {
  ...
  ArrayValueTypes.decode = function(decoder) {
    ...
    val.f6 = decoder.decodeArrayPointer(new codec.Interface(SomeInterfacePtr));
    val.f7 = decoder.decodeArrayPointer(codec.InterfaceRequest);
    return val;
  };
  ...
  MultiVersionStruct.decode = function(decoder) {
    ...
    val.fMessagePipe = decoder.decodeStruct(codec.NullableHandle);
    val.fRect = decoder.decodeStructPointer(rect$.Rect);
    val.fString = decoder.decodeStruct(codec.NullableString);
    val.fArray = decoder.decodeArrayPointer(codec.Int8);
    packed = decoder.readUint8();
    val.fBool = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    val.fInt16 = decoder.decodeStruct(codec.Int16);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ReorderedStruct.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.c = decoder.decodeStruct(codec.Int32);
    val.a = decoder.decodeStruct(codec.Int32);
    val.b = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ContainsInterface.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.someInterface = decoder.decodeStruct(new codec.Interface(SomeInterfacePtr));
    return val;
  };
  ...
  ContainsHashable.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.rect = decoder.decodeStructPointer(rect$.TypemappedRect);
    return val;
  };
  ...
  SimpleNestedStruct.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.nested = decoder.decodeStructPointer(ContainsOther);
    return val;
  };
  ...
  SomeInterface_SomeMethod_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.otherPair = decoder.decodeStructPointer(RectPair);
    return val;
  };
