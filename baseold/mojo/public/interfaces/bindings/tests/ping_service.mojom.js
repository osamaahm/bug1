...
(function() {
  ...
  EchoService_Echo_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.testData = decoder.decodeStruct(codec.String);
    return val;
  };
  ...
  EchoService_Echo_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.echoData = decoder.decodeStruct(codec.String);
    return val;
  };
  ...
  HandleTrampoline_BounceOne_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.one = decoder.decodeStruct(codec.Handle);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  HandleTrampoline_BounceTwo_Params.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.one = decoder.decodeStruct(codec.Handle);
    val.two = decoder.decodeStruct(codec.Handle);
    return val;
  };
