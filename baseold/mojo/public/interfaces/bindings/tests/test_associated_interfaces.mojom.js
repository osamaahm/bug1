...
(function() {
  ...
  StructContainsAssociated.decode = function(decoder) {
    ...
    val.fooRemote = decoder.decodeStruct(codec.NullableAssociatedInterfacePtrInfo);
    val.fooReceiver = decoder.decodeStruct(codec.AssociatedInterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    val.fooRemotes = decoder.decodeArrayPointer(codec.AssociatedInterfacePtrInfo);
    val.fooReceivers = decoder.decodeArrayPointer(codec.AssociatedInterfaceRequest);
    return val;
  };
  ...
  InterfacePassesAssociated_PassFoo_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fooRemote = decoder.decodeStruct(codec.AssociatedInterfacePtrInfo);
    val.fooReceiver = decoder.decodeStruct(codec.AssociatedInterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  InterfacePassesAssociated_PassStruct_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fooStruct = decoder.decodeStructPointer(StructContainsAssociated);
    return val;
  };
  ...
  InterfacePassesAssociated_PassUnion_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fooUnion = decoder.decodeStruct(UnionContainsAssociated);
    return val;
  };
  ...
  IntegerSenderConnection_AsyncGetSender_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.sender = decoder.decodeStruct(codec.AssociatedInterfacePtrInfo);
    return val;
  };
