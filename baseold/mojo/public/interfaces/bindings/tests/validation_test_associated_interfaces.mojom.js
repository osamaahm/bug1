...
(function() {
  ...
  AssociatedConformanceTestInterface_Method0_Params.decode = function(decoder) {
    ...
    val.param0 = decoder.decodeStruct(codec.AssociatedInterfacePtrInfo);
    return val;
  };
  ...
  AssociatedConformanceTestInterface_Method1_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeStruct(codec.AssociatedInterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  AssociatedConformanceTestInterface_Method2_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeStruct(codec.NullableAssociatedInterfacePtrInfo);
    return val;
  };
  ...
  AssociatedConformanceTestInterface_Method3_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeArrayPointer(codec.AssociatedInterfacePtrInfo);
    return val;
  };
