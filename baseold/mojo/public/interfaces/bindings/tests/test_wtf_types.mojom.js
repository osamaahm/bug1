...
(function() {
  ...
  var TopLevelEnum = {};
  TopLevelEnum.E0 = 0;
  TopLevelEnum.E1 = TopLevelEnum.E0 + 1;
  ...
  TestWTFCodeGeneration.decode = function(decoder) {
    ...
    val.nullableStr = decoder.decodeStruct(codec.NullableString);
    val.strs = decoder.decodeArrayPointer(codec.String);
    val.nullableStrs = decoder.decodeArrayPointer(codec.NullableString);
    val.arrays = decoder.decodeArrayPointer(new codec.ArrayOf(codec.Int32));
    val.bools = decoder.decodeArrayPointer(codec.PackedBool);
    val.handles = decoder.decodeArrayPointer(codec.Handle);
    val.strMap = decoder.decodeMapPointer(codec.String, codec.NullableString);
    val.arrayMap = decoder.decodeMapPointer(codec.Int32, new codec.ArrayOf(codec.Int32));
    val.handleMap = decoder.decodeMapPointer(codec.Int32, codec.Handle);
    val.strMaps = decoder.decodeArrayPointer(new codec.MapOf(codec.String, codec.NullableString));
    return val;
  };
  ...
  TestWTFStruct.NestedEnum.E1 = TestWTFStruct.NestedEnum.E0 + 1;
  ...
  TestWTFStruct.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.str = decoder.decodeStruct(codec.String);
    val.integer = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  TestWTFStructWrapper.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.nestedStruct = decoder.decodeStructPointer(TestWTFStruct);
    val.arrayStruct = decoder.decodeArrayPointer(new codec.PointerTo(TestWTFStruct));
    val.mapStruct = decoder.decodeMapPointer(new codec.PointerTo(TestWTFStruct), new codec.PointerTo(TestWTFStruct));
    return val;
  };
  ...
  TestWTF_EchoStringArray_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.arr = decoder.decodeArrayPointer(codec.NullableString);
    return val;
  };
  ...
  var kTestWTF_EchoString_Name = 0;
  var kTestWTF_EchoStringArray_Name = 1;
  var kTestWTF_EchoStringMap_Name = 2;
  ...
  TestWTF.NestedEnum.E1 = TestWTF.NestedEnum.E0 + 1;
