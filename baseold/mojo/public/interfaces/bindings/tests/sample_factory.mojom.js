...
(function() {
  ...
  Request.decode = function(decoder) {
    ...
    val.morePipes = decoder.decodeArrayPointer(codec.Handle);
    val.obj = decoder.decodeStruct(new codec.NullableInterface(sample_import$.ImportedInterfacePtr));
    return val;
  };
  ...
  Factory_CreateNamedObject_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.obj = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  Factory_TakeImportedInterface_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.obj = decoder.decodeStruct(new codec.Interface(sample_import$.ImportedInterfacePtr));
    return val;
  };
