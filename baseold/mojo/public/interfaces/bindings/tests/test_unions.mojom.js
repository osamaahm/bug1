...
(function() {
  ...
  AnExtensibleEnum.SECOND = AnExtensibleEnum.FIRST + 1;
  AnExtensibleEnum.THIRD = AnExtensibleEnum.SECOND + 1;
  ...
  WrapperStruct.decode = function(decoder) {
    ...
    val.objectUnion = decoder.decodeStruct(ObjectUnion);
    val.podUnion = decoder.decodeStruct(PodUnion);
    val.handleUnion = decoder.decodeStruct(HandleUnion);
    return val;
  };
  ...
  DummyStruct.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fInt8 = decoder.decodeStruct(codec.Int8);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  SmallStruct.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.dummyStruct = decoder.decodeStructPointer(DummyStruct);
    val.podUnion = decoder.decodeStruct(PodUnion);
    val.podUnionArray = decoder.decodeArrayPointer(PodUnion);
    val.nullablePodUnionArray = decoder.decodeArrayPointer(PodUnion);
    val.sArray = decoder.decodeArrayPointer(new codec.PointerTo(DummyStruct));
    val.podUnionMap = decoder.decodeMapPointer(codec.String, PodUnion);
    val.nullablePodUnionMap = decoder.decodeMapPointer(codec.String, PodUnion);
    return val;
  };
  ...
  SmallObjStruct.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.objUnion = decoder.decodeStruct(ObjectUnion);
    val.fInt8 = decoder.decodeStruct(codec.Int8);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  TryNonNullStruct.decode = function(decoder) {
    ...
    val.nonNullable = decoder.decodeStructPointer(DummyStruct);
    return val;
  };
  ...
  ImportedUnionStruct.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.pointOrShape = decoder.decodeStruct(sample_import$.PointOrShape);
    return val;
  };
  ...
  SmallCache_SetIntValue_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.intValue = decoder.decodeStruct(codec.Int64);
    return val;
  };
  ...
  UnionInterface_Echo_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.inVal = decoder.decodeStruct(PodUnion);
    return val;
  };
  ...
  UnionInterface_Echo_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.outVal = decoder.decodeStruct(PodUnion);
    return val;
  };
    ...
    PodUnion.decode = function(decoder) {
      ...
      switch (tag) {
        ...
        case PodUnion.Tags.fBool:
          ...
          break;
        case PodUnion.Tags.fEnum:
          result.fEnum = decoder.decodeStruct(codec.Int32);
          break;
        case PodUnion.Tags.fExtensibleEnum:
          result.fExtensibleEnum = decoder.decodeStruct(codec.Int32);
          break;
      }
      decoder.align();
