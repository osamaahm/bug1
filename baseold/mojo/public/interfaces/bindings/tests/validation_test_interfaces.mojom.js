...
(function() {
  ...
  var EnumA = {};
  EnumA.ENUM_A_0 = 0;
  EnumA.ENUM_A_1 = EnumA.ENUM_A_0 + 1;
  EnumA.MIN_VALUE = 0,
  EnumA.MAX_VALUE = 1,
  ...
  var EnumB = {};
  EnumB.ENUM_B_0 = 0;
  EnumB.ENUM_B_1 = EnumB.ENUM_B_0 + 1;
  EnumB.ENUM_B_2 = EnumB.ENUM_B_1 + 1;
  EnumB.MIN_VALUE = 0,
  EnumB.MAX_VALUE = 2,
  ...
  StructB.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.structA = decoder.decodeStructPointer(StructA);
    return val;
  };
  ...
  StructD.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.messagePipes = decoder.decodeArrayPointer(codec.Handle);
    return val;
  };
  ...
  StructE.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.structD = decoder.decodeStructPointer(StructD);
    val.dataPipeConsumer = decoder.decodeStruct(codec.Handle);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  StructF.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fixedSizeArray = decoder.decodeArrayPointer(codec.Uint8);
    return val;
  };
  ...
  Recursive.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.recursive = decoder.decodeStructPointer(Recursive);
    return val;
  };
  ...
  ConformanceTestInterface_Method13_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeStruct(new codec.NullableInterface(InterfaceAPtr));
    val.param1 = decoder.decodeStruct(codec.Uint32);
    val.param2 = decoder.decodeStruct(new codec.NullableInterface(InterfaceAPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  ConformanceTestInterface_Method14_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeStruct(codec.Int32);
    val.param1 = decoder.decodeStruct(codec.Int32);
    return val;
  };
  ...
  ConformanceTestInterface_Method15_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeArrayPointer(new codec.Enum(EnumA));
    val.param1 = decoder.decodeArrayPointer(new codec.Enum(EnumB));
    return val;
  };
  ...
  ConformanceTestInterface_Method16_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeMapPointer(new codec.Enum(EnumA), new codec.Enum(EnumA));
    return val;
  };
  ...
  ConformanceTestInterface_Method17_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeArrayPointer(new codec.Interface(InterfaceAPtr));
    return val;
  };
  ...
  ConformanceTestInterface_Method20_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.param0 = decoder.decodeMapPointer(new codec.PointerTo(StructB), codec.Uint8);
    return val;
  };
