// content/shell/common/web_test/fake_bluetooth_chooser.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  var mojomId = 'content/shell/common/web_test/fake_bluetooth_chooser.mojom';
  ...
  FakeBluetoothChooserFactory_CreateFakeBluetoothChooser_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.fakeChooser = decoder.decodeStruct(codec.InterfaceRequest);
  ...
  FakeBluetoothChooserFactoryStub.prototype.accept = function(message) {
    ...
    case kFakeBluetoothChooserFactory_CreateFakeBluetoothChooser_Name:
      ...
      this.createFakeBluetoothChooser(params.fakeChooser, params.client);
      return true;
    default:
      return false;
    }
  ...
  FakeBluetoothChooserFactoryProxy.prototype.validator = null;
