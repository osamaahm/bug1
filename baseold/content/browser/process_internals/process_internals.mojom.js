...
(function() {
  ...
  ProcessInternalsHandler_GetGloballyIsolatedOrigins_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.isolatedOrigins = decoder.decodeArrayPointer(new codec.PointerTo(IsolatedOriginInfo));
    return val;
  };
  ...
  var kProcessInternalsHandler_GetUserTriggeredIsolatedOrigins_Name = 1;
  var kProcessInternalsHandler_GetGloballyIsolatedOrigins_Name = 2;
  var kProcessInternalsHandler_GetAllWebContentsInfo_Name = 3;
