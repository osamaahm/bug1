...
(function() {
  ...
  TestMessageTarget_Echo_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.nested = decoder.decodeStruct(codec.Int32);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kTestMessageTarget_Flatten_Name = 4;
  var kTestMessageTarget_FlattenUnions_Name = 5;
  var kTestMessageTarget_RequestSubinterface_Name = 6;
  ...
  TestMessageTarget.NestedEnum.kBar = TestMessageTarget.NestedEnum.kFoo + 1;
