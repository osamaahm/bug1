// content/test/data/lite_js_old_names_test.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  var mojomId = 'content/test/data/lite_js_old_names_test.mojom';
  ...
  var exports = mojo.internal.exposeNamespace('liteJsOldNamesTest.mojom');
  ...
  TestStruct.encodedSize = codec.kStructHeaderSize + 8;
  ...
  TestMessageTarget_Repeat_Params.decode = function(decoder) {
    ...
    val.numbers = decoder.decodeArrayPointer(codec.Int32);
    return val;
  };
  ...
  TestMessageTarget_Flatten_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.values = decoder.decodeArrayPointer(new codec.PointerTo(TestStruct));
    return val;
  };
  ...
  TestMessageTarget_FlattenUnions_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.unions = decoder.decodeArrayPointer(TestUnion);
    return val;
  };
  ...
  TestMessageTarget_FlattenUnions_ResponseParams.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.x = decoder.decodeArrayPointer(codec.Int32);
    val.s = decoder.decodeArrayPointer(codec.Int32);
    return val;
  };
  ...
  TestMessageTarget_RequestSubinterface_Params.validate = function(messageValidator, offset) {
    ...
    // validate TestMessageTarget_RequestSubinterface_Params.request
  ...
  TestMessageTarget_RequestSubinterface_Params.decode = function(decoder) {
    ...
    val.client = decoder.decodeStruct(new codec.Interface(SubinterfaceClientPtr));
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kTestMessageTarget_Flatten_Name = 3;
  var kTestMessageTarget_FlattenUnions_Name = 4;
  var kTestMessageTarget_RequestSubinterface_Name = 5;
  ...
  TestMessageTargetProxy.prototype.requestSubinterface = function(request, client) {
  ...
  TestMessageTargetStub.prototype.requestSubinterface = function(request, client) {
    return this.delegate_ && this.delegate_.requestSubinterface && this.delegate_.requestSubinterface(request, client);
  }
  ...
  TestMessageTargetStub.prototype.accept = function(message) {
    ...
    case kTestMessageTarget_RequestSubinterface_Name:
      ...
      this.requestSubinterface(params.request, params.client);
      return true;
    default:
      return false;
    }
  ...
  var TestMessageTarget = {
    name: 'lite_js_old_names_test.mojom.TestMessageTarget',
    kVersion: 0,
  ...
  var Subinterface = {
    name: 'lite_js_old_names_test.mojom.Subinterface',
    kVersion: 0,
  ...
  var SubinterfaceClient = {
    name: 'lite_js_old_names_test.mojom.SubinterfaceClient',
    kVersion: 0,
