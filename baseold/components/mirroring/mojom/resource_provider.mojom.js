...
(function() {
  ...
  AudioStreamCreatorClient_StreamCreated_Params.validate = function(messageValidator, offset) {
    ...
    // validate AudioStreamCreatorClient_StreamCreated_Params.clientRequest
  ...
  ResourceProvider_CreateAudioStream_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.client = decoder.decodeStruct(new codec.Interface(AudioStreamCreatorClientPtr));
    val.param = decoder.decodeStructPointer(audio_parameters$.AudioParameters);
  ...
  ResourceProvider_ConnectToRemotingSource_Params.decode = function(decoder) {
    ...
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.remoter = decoder.decodeStruct(new codec.Interface(remoting$.RemoterPtr));
    val.receiver = decoder.decodeStruct(codec.InterfaceRequest);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  var kAudioStreamCreatorClient_StreamCreated_Name = 0;
  ...
  AudioStreamCreatorClientProxy.prototype.streamCreated = function(stream, clientRequest, dataPipe, initiallyMuted) {
  ...
  AudioStreamCreatorClientStub.prototype.streamCreated = function(stream, clientRequest, dataPipe, initiallyMuted) {
    return this.delegate_ && this.delegate_.streamCreated && this.delegate_.streamCreated(stream, clientRequest, dataPipe, initiallyMuted);
  }
  ...
  AudioStreamCreatorClientStub.prototype.accept = function(message) {
    ...
    case kAudioStreamCreatorClient_StreamCreated_Name:
      ...
      this.streamCreated(params.stream, params.clientRequest, params.dataPipe, params.initiallyMuted);
      return true;
    default:
      return false;
    }
  ...
  var kResourceProvider_BindGpu_Name = 0;
  var kResourceProvider_GetVideoCaptureHost_Name = 1;
  var kResourceProvider_GetNetworkContext_Name = 2;
  var kResourceProvider_CreateAudioStream_Name = 3;
  var kResourceProvider_ConnectToRemotingSource_Name = 4;
