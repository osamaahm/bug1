...
(function() {
  ...
  RendererContentSettingRules.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 40, 8, new codec.PointerTo(ContentSettingPatternSource), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  RendererContentSettingRules.encodedSize = codec.kStructHeaderSize + 48;
  ...
  RendererContentSettingRules.decode = function(decoder) {
    ...
    val.mixedContentRules = decoder.decodeArrayPointer(new codec.PointerTo(ContentSettingPatternSource));
    return val;
  };
