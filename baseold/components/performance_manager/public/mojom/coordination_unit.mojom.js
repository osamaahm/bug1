// components/performance_manager/public/mojom/coordination_unit.mojom.js is auto generated by mojom_bindings_generator.py, do not edit
...
(function() {
  var mojomId = 'components/performance_manager/public/mojom/coordination_unit.mojom';
  ...
  var lifecycle$ =
      mojo.internal.exposeNamespace('performanceManager.mojom');
  if (mojo.config.autoLoadMojomDeps) {
    mojo.internal.loadMojomIfNecessary(
        'components/performance_manager/public/mojom/lifecycle.mojom', 'lifecycle.mojom.js');
  }
  ...
  function DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.prototype.initDefaults_ = function() {
    this.policy = 0;
  };
  DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.policy
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 0, InterventionPolicy);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.encodedSize = codec.kStructHeaderSize + 8;

  DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.decode = function(decoder) {
    var packed;
    var val = new DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
  ...
  DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.encodedSize);
    encoder.writeUint32(0);
  ...
  var kDocumentCoordinationUnit_SetNetworkAlmostIdle_Name = 0;
  var kDocumentCoordinationUnit_SetLifecycleState_Name = 1;
  var kDocumentCoordinationUnit_SetHasNonEmptyBeforeUnload_Name = 2;
  var kDocumentCoordinationUnit_SetOriginTrialFreezePolicy_Name = 3;
  var kDocumentCoordinationUnit_SetIsAdFrame_Name = 4;
  var kDocumentCoordinationUnit_OnNonPersistentNotificationCreated_Name = 5;
  ...
  DocumentCoordinationUnitPtr.prototype.setOriginTrialFreezePolicy = function() {
    return DocumentCoordinationUnitProxy.prototype.setOriginTrialFreezePolicy
        .apply(this.ptr.getProxy(), arguments);
  };

  DocumentCoordinationUnitProxy.prototype.setOriginTrialFreezePolicy = function(policy) {
    var params_ = new DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params();
    params_.policy = policy;
    var builder = new codec.MessageV0Builder(
        kDocumentCoordinationUnit_SetOriginTrialFreezePolicy_Name,
        codec.align(DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params.encodedSize));
    builder.encodeStruct(DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params, params_);
    var message = builder.finish();
    this.receiver_.accept(message);
  };
  ...
  DocumentCoordinationUnitStub.prototype.setOriginTrialFreezePolicy = function(policy) {
    return this.delegate_ && this.delegate_.setOriginTrialFreezePolicy && this.delegate_.setOriginTrialFreezePolicy(policy);
  }
  ...
  DocumentCoordinationUnitStub.prototype.accept = function(message) {
    ...
    case kDocumentCoordinationUnit_SetHasNonEmptyBeforeUnload_Name:
      ...
      return true;
    case kDocumentCoordinationUnit_SetOriginTrialFreezePolicy_Name:
      var params = reader.decodeStruct(DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params);
      this.setOriginTrialFreezePolicy(params.policy);
      return true;
  ...
  function validateDocumentCoordinationUnitRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kDocumentCoordinationUnit_SetOriginTrialFreezePolicy_Name:
        if (!message.expectsResponse() && !message.isResponse())
          paramsClass = DocumentCoordinationUnit_SetOriginTrialFreezePolicy_Params;
      break;
      case kDocumentCoordinationUnit_SetIsAdFrame_Name:
        if (!message.expectsResponse() && !message.isResponse())
  ...
  var kProcessCoordinationUnit_SetExpectedTaskQueueingDuration_Name = 0;
  var kProcessCoordinationUnit_SetMainThreadTaskLoadIsLow_Name = 1;
