...
(function() {
  ...
  QuarantineFileResult.ACCESS_DENIED = QuarantineFileResult.OK + 1;
  QuarantineFileResult.BLOCKED_BY_POLICY = QuarantineFileResult.ACCESS_DENIED + 1;
  QuarantineFileResult.ANNOTATION_FAILED = QuarantineFileResult.BLOCKED_BY_POLICY + 1;
  QuarantineFileResult.FILE_MISSING = QuarantineFileResult.ANNOTATION_FAILED + 1;
  QuarantineFileResult.SECURITY_CHECK_FAILED = QuarantineFileResult.FILE_MISSING + 1;
  QuarantineFileResult.VIRUS_INFECTED = QuarantineFileResult.SECURITY_CHECK_FAILED + 1;
  ...
  Quarantine_QuarantineFile_Params.decode = function(decoder) {
    ...
    val.fullPath = decoder.decodeStructPointer(file_path$.FilePath);
    val.sourceUrl = decoder.decodeStructPointer(url$.Url);
    val.referrerUrl = decoder.decodeStructPointer(url$.Url);
    val.clientGuid = decoder.decodeStruct(codec.String);
    return val;
  };
  ...
  var kQuarantine_QuarantineFile_Name = 0;
